...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 119,489-byte compiler manifest hashes in 22,878,236 history-free transitions under its 24,891,362-transition budget. This checks linear work, not the patience of a progress bar.
