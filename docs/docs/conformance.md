...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 136,312-byte compiler manifest hashes in 26,100,068 history-free transitions under its 28,213,000-transition budget. This checks linear work, not the patience of a progress bar.
