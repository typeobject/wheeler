...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 132,498-byte compiler manifest hashes in 25,364,038 history-free transitions under its 27,427,400-transition budget. This checks linear work, not the patience of a progress bar.
