...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 124,130-byte compiler manifest hashes in 23,759,684 history-free transitions under its 25,826,000-transition budget. This checks linear work, not the patience of a progress bar.
