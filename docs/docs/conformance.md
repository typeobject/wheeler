...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 102,368-byte compiler manifest hashes in 19,596,060 history-free transitions under its 21,473,600-transition budget. This checks linear work, not the patience of a progress bar.
