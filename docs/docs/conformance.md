...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 118,798-byte compiler manifest hashes in 22,743,426 history-free transitions under its 24,756,552-transition budget. This checks linear work, not the patience of a progress bar.
