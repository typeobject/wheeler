...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 129,406-byte compiler manifest hashes in 24,777,452 history-free transitions under its 26,877,600-transition budget. This checks linear work, not the patience of a progress bar.
