...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 127,798-byte compiler manifest hashes in 24,457,546 history-free transitions under its 26,556,000-transition budget. This checks linear work, not the patience of a progress bar.
