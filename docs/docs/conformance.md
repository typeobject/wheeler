...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 111,357-byte compiler manifest hashes in 21,324,088 history-free transitions under its 23,271,400-transition budget. This checks linear work, not the patience of a progress bar.
