...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 126,493-byte compiler manifest hashes in 24,212,826 history-free transitions under its 26,298,600-transition budget. This checks linear work, not the patience of a progress bar.
