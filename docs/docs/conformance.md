...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 98,273-byte compiler manifest hashes in 18,812,308 history-free transitions under its 20,654,600-transition budget. This checks linear work, not the patience of a progress bar.
