...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 122,804-byte compiler manifest hashes in 23,502,374 history-free transitions under its 25,560,800-transition budget. This checks linear work, not the patience of a progress bar.
