...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 119,344-byte compiler manifest hashes in 22,841,122 history-free transitions under its 24,854,248-transition budget. This checks linear work, not the patience of a progress bar.
