...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 99,935-byte compiler manifest hashes in 19,130,720 history-free transitions under its 20,987,000-transition budget. This checks linear work, not the patience of a progress bar.
