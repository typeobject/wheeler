...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 130,214-byte compiler manifest hashes in 24,923,022 history-free transitions under its 27,039,200-transition budget. This checks linear work, not the patience of a progress bar.
