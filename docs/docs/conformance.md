...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 131,654-byte compiler manifest hashes in 25,204,936 history-free transitions under its 27,309,800-transition budget. This checks linear work, not the patience of a progress bar.
