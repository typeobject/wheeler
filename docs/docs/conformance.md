...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 123,814-byte compiler manifest hashes in 23,698,422 history-free transitions under its 25,762,800-transition budget. This checks linear work, not the patience of a progress bar.
