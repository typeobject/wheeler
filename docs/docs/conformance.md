...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 135,847-byte compiler manifest hashes in 26,000,662 history-free transitions under its 27,662,600-transition budget. This checks linear work, not the patience of a progress bar.
