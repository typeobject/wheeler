...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 117,309-byte compiler manifest hashes in 22,462,966 history-free transitions under its 24,461,800-transition budget. This checks linear work, not the patience of a progress bar.
