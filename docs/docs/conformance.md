...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 130,685-byte compiler manifest hashes in 25,022,380 history-free transitions under its 27,133,400-transition budget. This checks linear work, not the patience of a progress bar.
