...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 105,501-byte compiler manifest hashes in 20,196,138 history-free transitions under its 22,100,200-transition budget. This checks linear work, not the patience of a progress bar.
