...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 102,810-byte compiler manifest hashes in 19,681,830 history-free transitions under its 21,562,000-transition budget. This checks linear work, not the patience of a progress bar.
