...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 125,148-byte compiler manifest hashes in 23,955,668 history-free transitions under its 26,029,600-transition budget. This checks linear work, not the patience of a progress bar.
