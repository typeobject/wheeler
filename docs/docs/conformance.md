...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 126,189-byte compiler manifest hashes in 24,151,468 history-free transitions under its 26,237,800-transition budget. This checks linear work, not the patience of a progress bar.
