...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 122,347-byte compiler manifest hashes in 23,416,724 history-free transitions under its 25,469,400-transition budget. This checks linear work, not the patience of a progress bar.
