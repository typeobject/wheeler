...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 118,927-byte compiler manifest hashes in 22,767,910 history-free transitions under its 24,785,400-transition budget. This checks linear work, not the patience of a progress bar.
