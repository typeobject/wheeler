...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 93,277-byte compiler manifest hashes in 17,857,152 history-free transitions under its 19,655,400-transition budget. This checks linear work, not the patience of a progress bar.
