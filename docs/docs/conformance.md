...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 127,357-byte compiler manifest hashes in 24,385,588 history-free transitions under its 26,467,800-transition budget. This checks linear work, not the patience of a progress bar.
