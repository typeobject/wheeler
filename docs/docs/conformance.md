...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 133,226-byte compiler manifest hashes in 25,498,552 history-free transitions under its 27,545,000-transition budget. This checks linear work, not the patience of a progress bar.
