...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 135,866-byte compiler manifest hashes in 26,014,330 history-free transitions under its 28,173,200-transition budget. This checks linear work, not the patience of a progress bar.
