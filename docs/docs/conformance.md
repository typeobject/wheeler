...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 116,688-byte compiler manifest hashes in 22,339,292 history-free transitions under its 24,337,600-transition budget. This checks linear work, not the patience of a progress bar.
