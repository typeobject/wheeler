...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 94,057-byte compiler manifest hashes in 18,004,008 history-free transitions under its 19,811,400-transition budget. This checks linear work, not the patience of a progress bar.
