...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 114,684-byte compiler manifest hashes in 21,960,888 history-free transitions under its 23,936,800-transition budget. This checks linear work, not the patience of a progress bar.
