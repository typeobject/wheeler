...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 133,605-byte compiler manifest hashes in 25,572,068 history-free transitions under its 27,603,800-transition budget. This checks linear work, not the patience of a progress bar.
