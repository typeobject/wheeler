...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 121,271-byte compiler manifest hashes in 23,208,441 history-free transitions under its 25,254,200-transition budget. This checks linear work, not the patience of a progress bar.
