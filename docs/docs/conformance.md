...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 106,311-byte compiler manifest hashes in 20,355,512 history-free transitions under its 22,262,200-transition budget. This checks linear work, not the patience of a progress bar.
