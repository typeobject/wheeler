...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 136,065-byte compiler manifest hashes in 26,049,950 history-free transitions under its 28,213,000-transition budget. This checks linear work, not the patience of a progress bar.
