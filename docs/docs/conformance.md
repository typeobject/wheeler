...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 107,789-byte compiler manifest hashes in 20,637,122 history-free transitions under its 22,557,800-transition budget. This checks linear work, not the patience of a progress bar.
