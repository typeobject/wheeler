...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 109,313-byte compiler manifest hashes in 20,931,122 history-free transitions under its 22,862,600-transition budget. This checks linear work, not the patience of a progress bar.
