...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 132,373-byte compiler manifest hashes in 25,339,522 history-free transitions under its 27,427,400-transition budget. This checks linear work, not the patience of a progress bar.
