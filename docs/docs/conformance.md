...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 126,916-byte compiler manifest hashes in 24,298,748 history-free transitions under its 26,383,200-transition budget. This checks linear work, not the patience of a progress bar.
