...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 113,633-byte compiler manifest hashes in 21,751,348 history-free transitions under its 23,726,600-transition budget. This checks linear work, not the patience of a progress bar.
