...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 112,383-byte compiler manifest hashes in 21,520,008 history-free transitions under its 23,476,600-transition budget. This checks linear work, not the patience of a progress bar.
