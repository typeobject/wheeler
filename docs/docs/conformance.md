...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 107,419-byte compiler manifest hashes in 20,563,534 history-free transitions under its 22,483,800-transition budget. This checks linear work, not the patience of a progress bar.
