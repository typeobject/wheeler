...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 112,046-byte compiler manifest hashes in 21,445,094 history-free transitions under its 23,409,200-transition budget. This checks linear work, not the patience of a progress bar.
