...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 119,541-byte compiler manifest hashes in 22,877,820 history-free transitions under its 24,890,946-transition budget. This checks linear work, not the patience of a progress bar.
