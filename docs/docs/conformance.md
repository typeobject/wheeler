...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 132,841-byte compiler manifest hashes in 25,425,084 history-free transitions under its 27,486,200-transition budget. This checks linear work, not the patience of a progress bar.
