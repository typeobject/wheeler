...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 108,934-byte compiler manifest hashes in 20,857,606 history-free transitions under its 22,786,800-transition budget. This checks linear work, not the patience of a progress bar.
