...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 124,531-byte compiler manifest hashes in 23,833,024 history-free transitions under its 25,906,200-transition budget. This checks linear work, not the patience of a progress bar.
