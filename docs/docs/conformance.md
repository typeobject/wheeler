...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 108,460-byte compiler manifest hashes in 20,759,334 history-free transitions under its 22,692,000-transition budget. This checks linear work, not the patience of a progress bar.
