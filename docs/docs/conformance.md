...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 135,745-byte compiler manifest hashes in 25,988,720 history-free transitions under its 27,662,600-transition budget. This checks linear work, not the patience of a progress bar.
