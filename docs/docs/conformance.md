...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 125,490-byte compiler manifest hashes in 24,016,722 history-free transitions under its 26,098,000-transition budget. This checks linear work, not the patience of a progress bar.
