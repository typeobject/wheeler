...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 109,684-byte compiler manifest hashes in 20,991,944 history-free transitions under its 22,936,800-transition budget. This checks linear work, not the patience of a progress bar.
