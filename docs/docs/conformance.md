...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 110,745-byte compiler manifest hashes in 21,200,342 history-free transitions under its 23,149,000-transition budget. This checks linear work, not the patience of a progress bar.
