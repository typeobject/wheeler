...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 116,991-byte compiler manifest hashes in 22,401,720 history-free transitions under its 24,398,200-transition budget. This checks linear work, not the patience of a progress bar.
