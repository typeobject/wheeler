...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 128,205-byte compiler manifest hashes in 24,543,596 history-free transitions under its 26,637,400-transition budget. This checks linear work, not the patience of a progress bar.
