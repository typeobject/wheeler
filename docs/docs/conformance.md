...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 104,764-byte compiler manifest hashes in 20,062,758 history-free transitions under its 21,952,800-transition budget. This checks linear work, not the patience of a progress bar.
