...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 106,551-byte compiler manifest hashes in 20,391,861 history-free transitions under its 22,310,200-transition budget. This checks linear work, not the patience of a progress bar.
