...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 110,383-byte compiler manifest hashes in 21,126,690 history-free transitions under its 23,076,600-transition budget. This checks linear work, not the patience of a progress bar.
