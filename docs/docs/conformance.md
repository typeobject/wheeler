...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 105,469-byte compiler manifest hashes in 20,197,456 history-free transitions under its 22,093,800-transition budget. This checks linear work, not the patience of a progress bar.
