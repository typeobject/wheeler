...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 116,026-byte compiler manifest hashes in 22,218,070 history-free transitions under its 24,205,200-transition budget. This checks linear work, not the patience of a progress bar.
