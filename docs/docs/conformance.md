...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 126,129-byte compiler manifest hashes in 24,139,190 history-free transitions under its 26,225,800-transition budget. This checks linear work, not the patience of a progress bar.
