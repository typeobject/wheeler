...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 136,696-byte compiler manifest hashes in 26,175,042 history-free transitions under its 28,339,200-transition budget. This checks linear work, not the patience of a progress bar.
