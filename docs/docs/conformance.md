...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 98,344-byte compiler manifest hashes in 18,824,498 history-free transitions under its 20,668,800-transition budget. This checks linear work, not the patience of a progress bar.
