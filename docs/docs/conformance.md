...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 119,595-byte compiler manifest hashes in 22,890,146 history-free transitions under its 24,919,000-transition budget. This checks linear work, not the patience of a progress bar.
