...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 124,832-byte compiler manifest hashes in 23,894,406 history-free transitions under its 25,966,400-transition budget. This checks linear work, not the patience of a progress bar.
