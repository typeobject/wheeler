...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 123,504-byte compiler manifest hashes in 23,637,112 history-free transitions under its 25,700,800-transition budget. This checks linear work, not the patience of a progress bar.
