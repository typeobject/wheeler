...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 118,235-byte compiler manifest hashes in 22,633,108 history-free transitions under its 24,647,000-transition budget. This checks linear work, not the patience of a progress bar.
