...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 130,979-byte compiler manifest hashes in 25,069,998 history-free transitions under its 27,192,200-transition budget. This checks linear work, not the patience of a progress bar.
