...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 109,723-byte compiler manifest hashes in 21,004,390 history-free transitions under its 22,944,600-transition budget. This checks linear work, not the patience of a progress bar.
