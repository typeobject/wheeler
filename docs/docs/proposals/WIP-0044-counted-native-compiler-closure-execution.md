...
- [x] `ArchiveModuleSources.w` joins all 295 physical compiler modules to exact digest-matching archive ranges. A mismatched source identity leaves publication untouched.
...
- The current 295-module compiler closure plans without truncation.
