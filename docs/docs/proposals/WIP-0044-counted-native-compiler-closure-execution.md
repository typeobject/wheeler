...
- [x] `ArchiveModuleSources.w` joins all 284 physical compiler modules to exact digest-matching archive ranges. A mismatched source identity leaves publication untouched.
...
- The current 284-module compiler closure plans without truncation.
