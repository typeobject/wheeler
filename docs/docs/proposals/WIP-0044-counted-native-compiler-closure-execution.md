...
- [x] `ArchiveModuleSources.w` joins all 230 physical compiler modules to exact digest-matching archive ranges. A mismatched source identity leaves publication untouched.
...
- [x] WIP-0045 owns semantic module products. Scalar compilation now transfers validated declarations and values instead of retaining linked source. Callable and aggregate products remain.
...
- The current 230-module compiler closure plans without truncation.
