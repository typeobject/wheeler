...
- [x] `ArchiveModuleSources.w` joins all 228 physical compiler modules to exact digest-matching archive ranges. A mismatched source identity leaves publication untouched.
...
- [x] WIP-0045 now owns semantic module products. Its first pass transfers counted scalar declarations instead of retaining linked source.
...
- The current 228-module compiler closure plans without truncation.
