...
- [x] `ArchiveModuleSources.w` joins all 300 physical compiler modules to exact digest-matching archive ranges. A mismatched source identity leaves publication untouched.
...
- The current 300-module compiler closure plans without truncation.
