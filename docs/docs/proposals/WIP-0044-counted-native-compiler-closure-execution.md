...
- [x] `ArchiveModuleSources.w` joins all 292 physical compiler modules to exact digest-matching archive ranges. A mismatched source identity leaves publication untouched.
...
- The current 292-module compiler closure plans without truncation.
