...
- [x] `ArchiveModuleSources.w` joins all 273 physical compiler modules to exact digest-matching archive ranges. A mismatched source identity leaves publication untouched.
...
- The current 273-module compiler closure plans without truncation.
