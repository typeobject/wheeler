...
- [x] The 238-module physical compiler closure publishes 1,043 scalar declarations and reaches generation 238.
...
- [x] The physical compiler closure publishes 1,023 callable signatures with peak active source count one.
