...
- [x] The 239-module physical compiler closure publishes 1,053 scalar declarations and reaches generation 239.
...
- [x] The physical compiler closure publishes 1,024 callable signatures with peak active source count one.
