...
- [x] The 284-module physical compiler closure publishes 1,307 scalar declarations and reaches generation 284.
...
- [x] The physical compiler closure publishes 1,185 callable signatures with peak active source count one.
