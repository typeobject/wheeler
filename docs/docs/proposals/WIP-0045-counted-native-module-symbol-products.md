...
- [x] The 296-module physical compiler closure publishes 1,405 scalar declarations and reaches generation 296.
...
- [x] The physical compiler closure publishes 1,209 callable signatures with peak active source count one.
