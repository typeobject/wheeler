...
- [x] The 298-module physical compiler closure publishes 1,418 scalar declarations and reaches generation 298.
...
- [x] The physical compiler closure publishes 1,212 callable signatures with peak active source count one.
