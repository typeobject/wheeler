...
- [x] The 256-module physical compiler closure publishes 1,163 scalar declarations and reaches generation 256.
...
- [x] The physical compiler closure publishes 1,072 callable signatures with peak active source count one.
