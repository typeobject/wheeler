...
- [x] The 246-module physical compiler closure publishes 1,098 scalar declarations and reaches generation 246.
...
- [x] The physical compiler closure publishes 1,041 callable signatures with peak active source count one.
