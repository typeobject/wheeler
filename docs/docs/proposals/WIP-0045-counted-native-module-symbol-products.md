...
- [x] The 236-module physical compiler closure publishes 1,024 scalar declarations and reaches generation 236.
...
- [x] The physical compiler closure publishes 1,018 callable signatures with peak active source count one.
