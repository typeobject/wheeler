...
- [x] The 292-module physical compiler closure publishes 1,380 scalar declarations and reaches generation 292.
...
- [x] The physical compiler closure publishes 1,203 callable signatures with peak active source count one.
