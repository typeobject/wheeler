...
- [x] The 268-module physical compiler closure publishes 1,219 scalar declarations and reaches generation 268.
...
- [x] The physical compiler closure publishes 1,111 callable signatures with peak active source count one.
