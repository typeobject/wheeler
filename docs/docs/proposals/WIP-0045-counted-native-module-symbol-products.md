...
- [x] The 286-module physical compiler closure publishes 1,315 scalar declarations and reaches generation 286.
...
- [x] The physical compiler closure publishes 1,189 callable signatures with peak active source count one.
