...
- [x] The 304-module physical compiler closure publishes 1,457 scalar declarations and reaches generation 302.
...
- [x] The physical compiler closure publishes 1,226 callable signatures with peak active source count one.
