...
- [x] The 276-module physical compiler closure publishes 1,260 scalar declarations and reaches generation 276.
...
- [x] The physical compiler closure publishes 1,147 callable signatures with peak active source count one.
