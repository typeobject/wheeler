...
- [x] The 247-module physical compiler closure publishes 1,111 scalar declarations and reaches generation 247.
...
- [x] The physical compiler closure publishes 1,046 callable signatures with peak active source count one.
...
- [ ] Closure-wide compiled local-limit columns publish.
