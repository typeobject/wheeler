...
- [x] The 253-module physical compiler closure publishes 1,143 scalar declarations and reaches generation 253.
...
- [x] The physical compiler closure publishes 1,061 callable signatures with peak active source count one.
