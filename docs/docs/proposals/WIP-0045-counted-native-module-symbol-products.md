...
- [x] The 277-module physical compiler closure publishes 1,269 scalar declarations and reaches generation 277.
...
- [x] The physical compiler closure publishes 1,149 callable signatures with peak active source count one.
