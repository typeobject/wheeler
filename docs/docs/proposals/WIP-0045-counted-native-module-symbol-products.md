...
- [x] The 245-module physical compiler closure publishes 1,094 scalar declarations and reaches generation 245.
...
- [x] The physical compiler closure publishes 1,037 callable signatures with peak active source count one.
