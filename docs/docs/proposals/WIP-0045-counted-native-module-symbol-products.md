...
- [x] The 304-module physical compiler closure publishes 1,496 scalar declarations and reaches generation 302.
...
- [x] The physical compiler closure publishes 1,260 callable signatures with peak active source count one.
