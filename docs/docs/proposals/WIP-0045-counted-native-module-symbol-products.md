...
- [x] The 282-module physical compiler closure publishes 1,298 scalar declarations and reaches generation 282.
...
- [x] The physical compiler closure publishes 1,180 callable signatures with peak active source count one.
