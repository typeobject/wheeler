...
- [x] The 288-module physical compiler closure publishes 1,338 scalar declarations and reaches generation 288.
...
- [x] The physical compiler closure publishes 1,193 callable signatures with peak active source count one.
