...
- [x] The 301-module physical compiler closure publishes 1,438 scalar declarations and reaches generation 301.
...
- [x] The physical compiler closure publishes 1,218 callable signatures with peak active source count one.
