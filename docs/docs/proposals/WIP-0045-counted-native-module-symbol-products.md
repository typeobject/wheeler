...
- [x] The 285-module physical compiler closure publishes 1,311 scalar declarations and reaches generation 285.
...
- [x] The physical compiler closure publishes 1,187 callable signatures with peak active source count one.
