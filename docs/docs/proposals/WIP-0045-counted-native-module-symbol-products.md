...
- [x] The 287-module physical compiler closure publishes 1,325 scalar declarations and reaches generation 287.
...
- [x] The physical compiler closure publishes 1,191 callable signatures with peak active source count one.
