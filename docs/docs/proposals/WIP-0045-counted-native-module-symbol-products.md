...
- [x] The 279-module physical compiler closure publishes 1,284 scalar declarations and reaches generation 279.
...
- [x] The physical compiler closure publishes 1,160 callable signatures with peak active source count one.
