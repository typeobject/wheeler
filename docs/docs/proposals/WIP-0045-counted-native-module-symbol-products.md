...
- [x] The 260-module physical compiler closure publishes 1,182 scalar declarations and reaches generation 260.
...
- [x] The physical compiler closure publishes 1,083 callable signatures with peak active source count one.
