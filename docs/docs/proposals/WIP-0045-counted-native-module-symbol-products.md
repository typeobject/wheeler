...
- [x] The 295-module physical compiler closure publishes 1,397 scalar declarations and reaches generation 295.
...
- [x] The physical compiler closure publishes 1,208 callable signatures with peak active source count one.
