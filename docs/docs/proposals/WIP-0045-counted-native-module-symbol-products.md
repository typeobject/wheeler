...
- [x] The 283-module physical compiler closure publishes 1,305 scalar declarations and reaches generation 283.
...
- [x] The physical compiler closure publishes 1,183 callable signatures with peak active source count one.
