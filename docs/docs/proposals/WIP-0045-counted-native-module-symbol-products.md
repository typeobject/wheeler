...
- [x] The 272-module physical compiler closure publishes 1,242 scalar declarations and reaches generation 272.
...
- [x] The physical compiler closure publishes 1,140 callable signatures with peak active source count one.
