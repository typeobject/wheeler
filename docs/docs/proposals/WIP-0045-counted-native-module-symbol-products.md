...
- [x] The 293-module physical compiler closure publishes 1,385 scalar declarations and reaches generation 293.
...
- [x] The physical compiler closure publishes 1,204 callable signatures with peak active source count one.
