...
- [x] The 262-module physical compiler closure publishes 1,197 scalar declarations and reaches generation 262.
...
- [x] The physical compiler closure publishes 1,089 callable signatures with peak active source count one.
