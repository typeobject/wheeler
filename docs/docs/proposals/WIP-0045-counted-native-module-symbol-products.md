...
- [x] The 282-module physical compiler closure publishes 1,301 scalar declarations and reaches generation 282.
...
- [x] The physical compiler closure publishes 1,182 callable signatures with peak active source count one.
