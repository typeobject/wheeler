...
- [x] The 250-module physical compiler closure publishes 1,131 scalar declarations and reaches generation 250.
...
- [x] The physical compiler closure publishes 1,055 callable signatures with peak active source count one.
