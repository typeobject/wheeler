...
- [x] The 303-module physical compiler closure publishes 1,452 scalar declarations and reaches generation 302.
...
- [x] The physical compiler closure publishes 1,222 callable signatures with peak active source count one.
