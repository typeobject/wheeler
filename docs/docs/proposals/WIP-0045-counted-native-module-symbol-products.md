...
- [x] The 280-module physical compiler closure publishes 1,291 scalar declarations and reaches generation 280.
...
- [x] The physical compiler closure publishes 1,164 callable signatures with peak active source count one.
