...
- [x] The 248-module physical compiler closure publishes 1,119 scalar declarations and reaches generation 248.
...
- [x] The physical compiler closure publishes 1,050 callable signatures with peak active source count one.
