...
- [x] The 257-module physical compiler closure publishes 1,172 scalar declarations and reaches generation 257.
...
- [x] The physical compiler closure publishes 1,075 callable signatures with peak active source count one.
