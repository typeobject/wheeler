...
- [x] The 274-module physical compiler closure publishes 1,248 scalar declarations and reaches generation 274.
...
- [x] The physical compiler closure publishes 1,142 callable signatures with peak active source count one.
