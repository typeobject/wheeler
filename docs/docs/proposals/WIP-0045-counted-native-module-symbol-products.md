...
- [x] The 275-module physical compiler closure publishes 1,253 scalar declarations and reaches generation 275.
...
- [x] The physical compiler closure publishes 1,144 callable signatures with peak active source count one.
