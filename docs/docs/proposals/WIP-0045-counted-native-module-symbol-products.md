...
- [x] The 299-module physical compiler closure publishes 1,427 scalar declarations and reaches generation 299.
...
- [x] The physical compiler closure publishes 1,213 callable signatures with peak active source count one.
