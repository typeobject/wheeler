...
- [x] The 305-module physical compiler closure publishes 1,533 scalar declarations and reaches generation 305.
...
- [x] The physical compiler closure publishes 1,265 callable signatures with peak active source count one.
