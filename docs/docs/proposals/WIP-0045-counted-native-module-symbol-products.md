...
- [x] The 278-module physical compiler closure publishes 1,275 scalar declarations and reaches generation 278.
...
- [x] The physical compiler closure publishes 1,153 callable signatures with peak active source count one.
