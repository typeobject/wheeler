...
- [x] The 297-module physical compiler closure publishes 1,409 scalar declarations and reaches generation 297.
...
- [x] The physical compiler closure publishes 1,210 callable signatures with peak active source count one.
