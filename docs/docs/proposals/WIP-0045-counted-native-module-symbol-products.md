...
- [x] The 272-module physical compiler closure publishes 1,238 scalar declarations and reaches generation 272.
...
- [x] The physical compiler closure publishes 1,132 callable signatures with peak active source count one.
