...
- [x] The 281-module physical compiler closure publishes 1,292 scalar declarations and reaches generation 281.
...
- [x] The physical compiler closure publishes 1,177 callable signatures with peak active source count one.
