...
- [x] The 254-module physical compiler closure publishes 1,151 scalar declarations and reaches generation 254.
...
- [x] The physical compiler closure publishes 1,064 callable signatures with peak active source count one.
