...
- [x] The 255-module physical compiler closure publishes 1,158 scalar declarations and reaches generation 255.
...
- [x] The physical compiler closure publishes 1,069 callable signatures with peak active source count one.
