...
- [x] The 249-module physical compiler closure publishes 1,126 scalar declarations and reaches generation 249.
...
- [x] The physical compiler closure publishes 1,053 callable signatures with peak active source count one.
