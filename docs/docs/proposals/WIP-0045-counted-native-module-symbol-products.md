...
- [x] The 294-module physical compiler closure publishes 1,390 scalar declarations and reaches generation 294.
...
- [x] The physical compiler closure publishes 1,206 callable signatures with peak active source count one.
