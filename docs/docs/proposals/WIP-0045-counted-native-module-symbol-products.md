...
- [x] The 264-module physical compiler closure publishes 1,206 scalar declarations and reaches generation 264.
...
- [x] The physical compiler closure publishes 1,095 callable signatures with peak active source count one.
