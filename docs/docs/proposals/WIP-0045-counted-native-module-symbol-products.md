...
- [x] The 289-module physical compiler closure publishes 1,348 scalar declarations and reaches generation 289.
...
- [x] The physical compiler closure publishes 1,195 callable signatures with peak active source count one.
