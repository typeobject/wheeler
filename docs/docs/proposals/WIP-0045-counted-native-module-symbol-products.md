...
- [x] The 240-module physical compiler closure publishes 1,060 scalar declarations and reaches generation 240.
...
- [x] The physical compiler closure publishes 1,025 callable signatures with peak active source count one.
