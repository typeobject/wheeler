...
- [x] The 267-module physical compiler closure publishes 1,218 scalar declarations and reaches generation 267.
...
- [x] The physical compiler closure publishes 1,109 callable signatures with peak active source count one.
