...
- [x] The 304-module physical compiler closure publishes 1,460 scalar declarations and reaches generation 302.
...
- [x] The physical compiler closure publishes 1,228 callable signatures with peak active source count one.
