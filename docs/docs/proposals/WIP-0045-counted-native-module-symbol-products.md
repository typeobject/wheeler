...
- [x] The 237-module physical compiler closure publishes 1,033 scalar declarations and reaches generation 237.
...
- [x] The physical compiler closure publishes 1,022 callable signatures with peak active source count one.
