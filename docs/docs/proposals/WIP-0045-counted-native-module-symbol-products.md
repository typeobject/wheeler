...
- [x] The 300-module physical compiler closure publishes 1,431 scalar declarations and reaches generation 300.
...
- [x] The physical compiler closure publishes 1,216 callable signatures with peak active source count one.
