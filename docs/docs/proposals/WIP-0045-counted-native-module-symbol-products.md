...
- [x] The 235-module physical compiler closure publishes 1,017 scalar declarations and reaches generation 235.
...
- [x] The physical compiler closure publishes 1,014 callable signatures with peak active source count one.
