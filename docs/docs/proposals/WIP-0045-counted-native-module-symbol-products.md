...
- [x] The 291-module physical compiler closure publishes 1,369 scalar declarations and reaches generation 291.
...
- [x] The physical compiler closure publishes 1,201 callable signatures with peak active source count one.
