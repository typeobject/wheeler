...
- [x] The 265-module physical compiler closure publishes 1,209 scalar declarations and reaches generation 265.
...
- [x] The physical compiler closure publishes 1,101 callable signatures with peak active source count one.
