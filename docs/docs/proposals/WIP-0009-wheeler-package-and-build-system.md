...
- [ ] Vendor retries and relocation preserve exact locked bytes and reject poisoned files; XDG repository paths are identity-neutral and tested, while local/remote cache poisoning, cache deletion, and identity-preserving mirrors remain.
