...
- [ ] Unlocked resolution through configured repositories, repository identity in locks, build-input-keyed artifact reuse, quarantine/GC, mirrors, and signed network snapshots remain.
