...
- [ ] Resolved loop products join calls and nested blocks. `LoopBackEdgeProducts.w` now validates source-independent ownership state and back edges.
...
- [ ] Call and relocation joins validate loop back edges.
