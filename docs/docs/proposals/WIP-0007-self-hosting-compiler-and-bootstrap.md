...
- [ ] CI builds the full canonical workspace under independently distributed Temurin and Zulu JDK 26 toolchains and compares every output byte; the workflow is configured, but this checklist remains open until hosted runs provide the evidence.
