...
- [x] `AggregateCodegen.w` emits all canonical aggregate construction and projection instruction forms after complete operand and extent validation. Record construction and field projection match stage 0 byte for byte.
