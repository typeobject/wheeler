...
- [x] WIP-0050's `SourceAggregateProducts.w` publishes atomic recursive record and member ranges, primitive codes, and local nominal rows before source release.
