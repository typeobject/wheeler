...
- [x] WIP-0050's `SourceAggregateProducts.w` publishes atomic record, variant, case, and member ranges, primitive codes, and local nominal rows before source release.
