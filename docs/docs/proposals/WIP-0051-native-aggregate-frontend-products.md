...
- [x] Aggregate-aware compilation publishes parameter, statement-result, and function-local-count products before classifying local nominal carriers. Caller-supplied carrier coordinates no longer participate.
