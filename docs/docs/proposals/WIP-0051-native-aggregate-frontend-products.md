...
- [x] Aggregate-aware compilation publishes parameter, statement-result, nested-expression, and function-local-count products before classifying local nominal carriers. Caller-supplied carrier coordinates no longer participate.
