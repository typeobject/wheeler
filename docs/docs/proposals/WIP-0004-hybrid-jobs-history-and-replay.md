...
- [x] Local immediate and provider-delayed completion produce the same ordered semantic event shape. Run and job identities remain operational lineage and do not change event kinds, branches, workflow positions, values, or semantic details.
