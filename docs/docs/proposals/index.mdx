...
| [WIP-0043](WIP-0043-bounded-generic-compiler-module-graph-execution.md) | Implementing | Bounded generic compiler module graph execution | Self-hosting, modules, linking, graph execution |
