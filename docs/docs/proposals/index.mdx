...
| [WIP-0050](WIP-0050-native-aggregate-source-lowering.md) | Implementing | Native aggregate source lowering | Self-hosting, aggregates, ownership, relocation, compiler products |
