...
`dynamic void` is parser-owned reserved syntax for target-resident preparation, measurement, reset, and conditional work. It currently rejects with a stable diagnostic rather than silently lowering through the static circuit path.
