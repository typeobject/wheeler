...
signed literal or evaluated constant. Its bounded entry starts with one or more result
calls and may follow them with signed equality checks of those results. The compiler emits the canonical
