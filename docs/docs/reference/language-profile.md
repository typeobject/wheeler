...
signed literal or evaluated constant. Its bounded entry starts with one result call and
may follow it with signed equality checks of that result. The compiler emits the canonical
