...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 72,663-byte compiler manifest hashes in 13,913,988 history-free transitions under its 15,532,600-transition budget. This checks linear work, not the patience of a progress bar.
