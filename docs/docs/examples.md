...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 57,132-byte compiler manifest hashes in 10,938,042 history-free transitions under its 12,426,400-transition budget. This checks linear work, not the patience of a progress bar.
