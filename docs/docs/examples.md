...
- The current 39,479-byte compiler manifest hashes in 8,169,048 history-free transitions under an 8,400,000-transition evidence ceiling. This checks bytes, not the patience of a progress bar.
