...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 52,394-byte compiler manifest hashes in 10,031,854 history-free transitions under its 11,478,800-transition budget. This checks linear work, not the patience of a progress bar.
