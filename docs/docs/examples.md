...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 84,507-byte compiler manifest hashes in 16,179,466 history-free transitions under its 17,925,600-transition budget. This checks linear work, not the patience of a progress bar.
