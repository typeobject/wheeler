...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 75,863-byte compiler manifest hashes in 14,526,288 history-free transitions under its 16,172,600-transition budget. This checks linear work, not the patience of a progress bar.
