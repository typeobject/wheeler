...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 80,097-byte compiler manifest hashes in 15,334,444 history-free transitions under its 17,019,400-transition budget. This checks linear work, not the patience of a progress bar.
