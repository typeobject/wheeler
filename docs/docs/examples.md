...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 93,154-byte compiler manifest hashes in 17,832,620 history-free transitions under its 19,311,000-transition budget. This checks linear work, not the patience of a progress bar.
