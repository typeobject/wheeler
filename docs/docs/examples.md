...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 81,965-byte compiler manifest hashes in 15,689,482 history-free transitions under its 17,393,000-transition budget. This checks linear work, not the patience of a progress bar.
