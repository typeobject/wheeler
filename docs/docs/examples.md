...
- The current 35,422-byte compiler manifest hashes in 7,335,259 history-free transitions under a 7,600,000-transition evidence ceiling. This checks bytes, not the patience of a progress bar.
