...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 60,396-byte compiler manifest hashes in 11,562,588 history-free transitions under its 13,079,200-transition budget. This checks linear work, not the patience of a progress bar.
