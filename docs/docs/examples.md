...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 82,376-byte compiler manifest hashes in 15,775,500 history-free transitions under its 17,475,200-transition budget. This checks linear work, not the patience of a progress bar.
