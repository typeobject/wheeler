...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 68,870-byte compiler manifest hashes in 13,191,610 history-free transitions under its 14,774,000-transition budget. This checks linear work, not the patience of a progress bar.
