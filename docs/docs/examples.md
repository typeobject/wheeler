...
| [`RegionStorage.w`](../../wheeler-examples/src/main/wheeler/RegionStorage.w) | Bounded region allocation, mutable word/byte access, byte-range checks, affine ownership, and explicit drop | `first = 7`, `byteValue = 255` |
