...
- The current 45,793-byte compiler manifest hashes in 9,479,791 history-free transitions under a 10,000,000-transition evidence ceiling. This checks bytes, not the patience of a progress bar.
