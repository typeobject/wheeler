...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 64,311-byte compiler manifest hashes in 12,309,501 history-free transitions under its 13,862,200-transition budget. This checks linear work, not the patience of a progress bar.
