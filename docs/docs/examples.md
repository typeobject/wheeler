...
| [`Utf8Lexer.w`](../../wheeler-examples/src/main/wheeler/Utf8Lexer.w) + [`lexer/Parser.w`](../../wheeler-examples/src/main/wheeler/lexer/Parser.w) + [`lexer/Scanner.w`](../../wheeler-examples/src/main/wheeler/lexer/Scanner.w) | Explicit host UTF-8 source scanned and parsed by imported dependency-first modules into region-owned identifier/number/punctuation/raw-ASCII-literal/line-or-block-comment tokens with identifier-digit continuation, bounded signed-decimal parsing, stable scanner diagnostic codes/offsets, and a typed-local-declaration parser | input `long x2=123;/*c*/` gives `tokenCount = 6`, `numberStart = 8`, `commentStart = 12`, `numericValue = 123`, `lexicalCode = 0`, `outputLength = 3`, `finalCursor = 17`; malformed comment, literal, and token-capacity cases report codes 1, 2, and 3; output `123` |
