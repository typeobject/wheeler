...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 81,011-byte compiler manifest hashes in 15,505,744 history-free transitions under its 17,202,200-transition budget. This checks linear work, not the patience of a progress bar.
