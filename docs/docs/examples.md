...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 83,999-byte compiler manifest hashes in 16,081,466 history-free transitions under its 17,833,200-transition budget. This checks linear work, not the patience of a progress bar.
