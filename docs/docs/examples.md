...
| [`NativeManifest.w`](../../wheeler-examples/src/main/wheeler/NativeManifest.w) + [`packages/Manifest.w`](../../wheeler-examples/src/main/wheeler/packages/Manifest.w) | Wheeler-native bounded scanning and typed parsing of the mandatory `wheeler.package` header and one bounded example target | `package "demo.native" version "1.2.3" profile "bootstrap-1"; target example "app" root "src/App.w";` yields `nameStart = 9`, header lengths `11`, `5`, `11`, target lengths `3`, `9`, and exact rewind; a wrong declaration keyword traps instead of inventing a package |
