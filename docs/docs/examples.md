...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 82,429-byte compiler manifest hashes in 15,788,896 history-free transitions under its 17,485,800-transition budget. This checks linear work, not the patience of a progress bar.
