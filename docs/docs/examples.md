...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 84,747-byte compiler manifest hashes in 16,228,578 history-free transitions under its 18,018,000-transition budget. This checks linear work, not the patience of a progress bar.
