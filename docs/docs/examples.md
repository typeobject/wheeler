...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 90,812-byte compiler manifest hashes in 17,393,130 history-free transitions under its 19,162,400-transition budget. This checks linear work, not the patience of a progress bar.
