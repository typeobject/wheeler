...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 69,681-byte compiler manifest hashes in 13,338,218 history-free transitions under its 14,936,200-transition budget. This checks linear work, not the patience of a progress bar.
