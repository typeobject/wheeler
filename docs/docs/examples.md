...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 63,747-byte compiler manifest hashes in 12,211,954 history-free transitions under its 13,749,400-transition budget. This checks linear work, not the patience of a progress bar.
