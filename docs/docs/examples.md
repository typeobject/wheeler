...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 64,374-byte compiler manifest hashes in 12,321,760 history-free transitions under its 13,874,800-transition budget. This checks linear work, not the patience of a progress bar.
