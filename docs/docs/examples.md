...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 66,361-byte compiler manifest hashes in 12,715,182 history-free transitions under its 14,272,200-transition budget. This checks linear work, not the patience of a progress bar.
