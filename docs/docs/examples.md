...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 73,780-byte compiler manifest hashes in 14,121,938 history-free transitions under its 15,756,000-transition budget. This checks linear work, not the patience of a progress bar.
