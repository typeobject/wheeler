...
- The current 38,295-byte compiler manifest hashes in 7,931,025 history-free transitions under an 8,200,000-transition evidence ceiling. This checks bytes, not the patience of a progress bar.
