...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 94,843-byte compiler manifest hashes in 18,164,636 history-free transitions under its 19,968,600-transition budget. This checks linear work, not the patience of a progress bar.
