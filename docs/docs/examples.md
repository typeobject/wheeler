...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 52,966-byte compiler manifest hashes in 10,142,100 history-free transitions under its 11,593,200-transition budget. This checks linear work, not the patience of a progress bar.
