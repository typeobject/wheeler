...
- The current 36,522-byte compiler manifest hashes in 7,560,209 history-free transitions under a 7,700,000-transition evidence ceiling. This checks bytes, not the patience of a progress bar.
