...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 85,556-byte compiler manifest hashes in 16,375,202 history-free transitions under its 18,110,400-transition budget. This checks linear work, not the patience of a progress bar.
