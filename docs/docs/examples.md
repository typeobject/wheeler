...
| [`NativeManifest.w`](../../wheeler-examples/src/main/wheeler/NativeManifest.w) + [`packages/Manifest.w`](../../wheeler-examples/src/main/wheeler/packages/Manifest.w) | Wheeler-native bounded scanning and typed parsing of the mandatory `wheeler.package` header | `package "demo.native" version "1.2.3" profile "bootstrap-1";` yields `nameStart = 9`, lengths `11`, `5`, `11`, and exact rewind; a wrong declaration keyword traps instead of inventing a package |
