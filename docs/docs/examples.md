...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 83,263-byte compiler manifest hashes in 15,948,078 history-free transitions under its 17,652,600-transition budget. This checks linear work, not the patience of a progress bar.
