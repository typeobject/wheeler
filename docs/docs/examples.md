...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 74,970-byte compiler manifest hashes in 14,354,820 history-free transitions under its 15,994,000-transition budget. This checks linear work, not the patience of a progress bar.
