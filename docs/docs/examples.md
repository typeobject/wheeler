...
- The current 40,971-byte compiler manifest hashes in 8,487,117 history-free transitions under an 8,800,000-transition evidence ceiling. This checks bytes, not the patience of a progress bar.
