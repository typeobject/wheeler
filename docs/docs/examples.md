...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 94,790-byte compiler manifest hashes in 18,151,240 history-free transitions under its 19,958,000-transition budget. This checks linear work, not the patience of a progress bar.
