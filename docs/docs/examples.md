...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 62,333-byte compiler manifest hashes in 11,943,652 history-free transitions under its 13,466,600-transition budget. This checks linear work, not the patience of a progress bar.
