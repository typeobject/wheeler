...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 79,100-byte compiler manifest hashes in 15,152,112 history-free transitions under its 16,820,000-transition budget. This checks linear work, not the patience of a progress bar.
