...
- The current 35,056-byte compiler manifest hashes in 7,255,687 history-free transitions under a 7,400,000-transition evidence ceiling. This checks bytes, not the patience of a progress bar.
