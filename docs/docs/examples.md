...
| [`Utf8Lexer.w`](../../wheeler-examples/src/main/wheeler/Utf8Lexer.w) | Bounded immutable UTF-8 scanning of identifiers, numbers, punctuation, whitespace, and line comments into region-owned token buffers | `tokenCount = 5`, `numberStart = 2`, `commentStart = 6`, `numericValue = 123`, `finalCursor = 10` |
