...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 63,221-byte compiler manifest hashes in 12,101,340 history-free transitions under its 13,644,200-transition budget. This checks linear work, not the patience of a progress bar.
