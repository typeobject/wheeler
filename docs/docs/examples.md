...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 97,032-byte compiler manifest hashes in 18,579,834 history-free transitions under its 20,406,400-transition budget. This checks linear work, not the patience of a progress bar.
