...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 68,136-byte compiler manifest hashes in 13,044,386 history-free transitions under its 14,627,200-transition budget. This checks linear work, not the patience of a progress bar.
