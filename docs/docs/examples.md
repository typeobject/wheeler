...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 77,482-byte compiler manifest hashes in 14,832,286 history-free transitions under its 16,496,400-transition budget. This checks linear work, not the patience of a progress bar.
