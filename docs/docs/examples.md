...
- The current 49,571-byte compiler manifest hashes in 9,493,086 history-free transitions under a 10,000,000-transition evidence ceiling. This checks bytes, not the patience of a progress bar.
