...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 64,424-byte compiler manifest hashes in 12,334,118 history-free transitions under its 13,884,800-transition budget. This checks linear work, not the patience of a progress bar.
