...
- The current 45,481-byte compiler manifest hashes in 9,413,537 history-free transitions under a 10,000,000-transition evidence ceiling. This checks bytes, not the patience of a progress bar.
