...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 59,954-byte compiler manifest hashes in 11,476,818 history-free transitions under its 12,990,800-transition budget. This checks linear work, not the patience of a progress bar.
