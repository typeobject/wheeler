...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 86,729-byte compiler manifest hashes in 16,901,812 history-free transitions under its 18,202,800-transition budget. This checks linear work, not the patience of a progress bar.
