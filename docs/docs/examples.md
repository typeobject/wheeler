...
| [`BytecodeHeader.w`](../../wheeler-examples/src/main/wheeler/BytecodeHeader.w) + [`compiler/Encoding.w`](../../wheeler-examples/src/main/wheeler/compiler/Encoding.w) | Imported bounded little-endian integer emission through explicit host output | the 40-byte header and six-entry directory match stage 0; `finalCursor = 232` |
