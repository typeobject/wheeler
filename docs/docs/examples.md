...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 71,410-byte compiler manifest hashes in 13,668,852 history-free transitions under its 15,282,000-transition budget. This checks linear work, not the patience of a progress bar.
