...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 67,311-byte compiler manifest hashes in 12,885,132 history-free transitions under its 14,462,200-transition budget. This checks linear work, not the patience of a progress bar.
