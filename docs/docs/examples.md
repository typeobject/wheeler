...
| [`RegionStorage.w`](../../wheeler-examples/src/main/wheeler/RegionStorage.w) | Bounded region allocation, mutable word access, affine ownership, and explicit drop | `first = 7` |
