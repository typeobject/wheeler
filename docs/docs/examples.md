...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 76,870-byte compiler manifest hashes in 14,722,360 history-free transitions under its 16,374,000-transition budget. This checks linear work, not the patience of a progress bar.
