...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 76,237-byte compiler manifest hashes in 14,599,844 history-free transitions under its 16,247,400-transition budget. This checks linear work, not the patience of a progress bar.
