...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 65,601-byte compiler manifest hashes in 12,567,104 history-free transitions under its 14,120,200-transition budget. This checks linear work, not the patience of a progress bar.
