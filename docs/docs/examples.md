...
- Cases include signed and Boolean locals, signed-local equality assertions, literal or prior-local truth assertions, stateful updates, helper calls, reversible helpers, reverse blocks, and generated-inverse theorems.
