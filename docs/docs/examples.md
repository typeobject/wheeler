...
| [`BytecodeHeader.w`](../../wheeler-examples/src/main/wheeler/BytecodeHeader.w) + [`compiler/Encoding.w`](../../wheeler-examples/src/main/wheeler/compiler/Encoding.w) | Imported bounded little-endian integer emission through explicit host output | first 24 canonical `.wbc` header bytes; `finalCursor = 24` |
