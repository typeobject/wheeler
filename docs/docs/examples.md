...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 72,182-byte compiler manifest hashes in 13,815,772 history-free transitions under its 15,436,400-transition budget. This checks linear work, not the patience of a progress bar.
