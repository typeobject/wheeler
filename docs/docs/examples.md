...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 67,593-byte compiler manifest hashes in 12,946,666 history-free transitions under its 14,518,600-transition budget. This checks linear work, not the patience of a progress bar.
