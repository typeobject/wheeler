...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 78,481-byte compiler manifest hashes in 15,028,422 history-free transitions under its 16,696,200-transition budget. This checks linear work, not the patience of a progress bar.
