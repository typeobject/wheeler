...
| [`Utf8Lexer.w`](../../wheeler-examples/src/main/wheeler/Utf8Lexer.w) | Explicit host UTF-8 source scanned by an imported function module into region-owned identifier/number/punctuation/raw-ASCII-literal/line-or-block-comment tokens with bounded signed-decimal parsing, recoverable overflow, and an assignment-production parser | `tokenCount = 5`, `numberStart = 2`, `commentStart = 6`, `numericValue = 123`, `parseError = 0`, `outputLength = 3`, `finalCursor = 11`; output `123` |
