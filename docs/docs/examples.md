...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 96,151-byte compiler manifest hashes in 18,408,270 history-free transitions under its 20,230,200-transition budget. This checks linear work, not the patience of a progress bar.
