...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 70,099-byte compiler manifest hashes in 13,424,180 history-free transitions under its 15,019,800-transition budget. This checks linear work, not the patience of a progress bar.
