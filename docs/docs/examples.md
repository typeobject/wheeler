...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 73,045-byte compiler manifest hashes in 13,987,480 history-free transitions under its 15,609,000-transition budget. This checks linear work, not the patience of a progress bar.
