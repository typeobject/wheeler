...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 97,855-byte compiler manifest hashes in 18,740,166 history-free transitions under its 20,571,000-transition budget. This checks linear work, not the patience of a progress bar.
