...
- The current 41,271-byte compiler manifest hashes in 8,539,712 history-free transitions under an 8,800,000-transition evidence ceiling. This checks bytes, not the patience of a progress bar.
