...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 51,787-byte compiler manifest hashes in 9,921,888 history-free transitions under its 11,357,400-transition budget. This checks linear work, not the patience of a progress bar.
