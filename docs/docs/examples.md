...
- The current 42,833-byte compiler manifest hashes in 8,870,971 history-free transitions under a 10,000,000-transition evidence ceiling. This checks bytes, not the patience of a progress bar.
