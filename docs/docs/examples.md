...
- A named public, explicit-private, or unqualified zero- through sixteen-statement helper plus static entry call emits two descriptors, `RETURN`, and `CALL`.
