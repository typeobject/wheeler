...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 60,006-byte compiler manifest hashes in 11,489,160 history-free transitions under its 13,001,200-transition budget. This checks linear work, not the patience of a progress bar.
