...
- The current 35,981-byte compiler manifest hashes in 7,454,537 history-free transitions under a 7,600,000-transition evidence ceiling. This checks bytes, not the patience of a progress bar.
