...
- SHA evidence receives 1,000,000 startup transitions plus 200 transitions per input byte. The current 67,369-byte compiler manifest hashes in 12,897,426 history-free transitions under its 14,473,800-transition budget. This checks linear work, not the patience of a progress bar.
