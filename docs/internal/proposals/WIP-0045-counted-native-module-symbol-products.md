...
- [x] The 320-module measured symbol fixture publishes 1,706 declarations and reaches generation 316 with peak active source count one.
...
- [x] The physical compiler closure publishes 1,313 callable signatures with peak active source count one.
