...
- [x] The 323-module measured symbol fixture publishes 1,709 declarations and reaches generation 316 with peak active source count one.
...
- [x] The physical compiler closure publishes 1,319 callable signatures with peak active source count one.
