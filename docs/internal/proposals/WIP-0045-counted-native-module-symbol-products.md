...
- [x] The 324-module measured symbol fixture publishes 1,724 declarations and reaches generation 316 with peak active source count one.
...
- [x] The physical compiler closure publishes 1,325 callable signatures with peak active source count one.
