...
- [x] The 316-module measured symbol fixture publishes 1,680 declarations and reaches generation 316 with peak active source count one.
...
- [x] The physical compiler closure publishes 1,309 callable signatures with peak active source count one.
