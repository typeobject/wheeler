...
- [x] The 306-module measured symbol fixture publishes 1,564 scalar declarations and reaches generation 305. Later source-product modules do not change that recorded fixture.
...
- [x] The physical compiler closure publishes 1,271 callable signatures with peak active source count one.
