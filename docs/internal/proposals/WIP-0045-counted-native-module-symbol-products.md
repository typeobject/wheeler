...
- [x] The 318-module measured symbol fixture publishes 1,694 declarations and reaches generation 316 with peak active source count one.
...
- [x] The physical compiler closure publishes 1,311 callable signatures with peak active source count one.
