...
- [x] The 317-module measured symbol fixture publishes 1,688 declarations and reaches generation 316 with peak active source count one.
...
- [x] The physical compiler closure publishes 1,310 callable signatures with peak active source count one.
