...
`NativeCompilerPhysicalClosureExampleTest` now compares all 110 selected artifacts, retained prefixes, and relocations. WIP-0411 adds the direct assignment-syntax product and closes the wide-local dependency named by `CallForms.w`. WIP-0413 adds the guarded UTF-8 call owner without a broad token-module edge. WIP-0414 retains separate statement, decoder, signed, and nonsigned result owners. WIP-0415 retains the manifest assertion classifier. WIP-0416 retains the profile classifier after admitting Boolean source children. WIP-0420 retains the package-manifest token product, and WIP-0421 retains the package-name validators. Each fresh test run links 305 functions and 11,696 instructions, retains 8,651 local types and 276,472 code bytes, and reproduces SHA-256 `013a36b669707f89add1c615558cdeb593460ebdc24e264caff6d37fb8b8877f`. Complete evidence passes in about 20 minutes under the twenty-four-minute method deadline.
