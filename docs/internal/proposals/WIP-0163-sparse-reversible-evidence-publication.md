...
`NativeCompilerPhysicalClosureExampleTest` now compares all 121 selected artifacts, retained prefixes, and relocations. WIP-0411 adds the direct assignment-syntax product and closes the wide-local dependency named by `CallForms.w`. WIP-0413 adds the guarded UTF-8 call owner without a broad token-module edge. WIP-0414 retains separate statement, decoder, signed, and nonsigned result owners. WIP-0415 retains the manifest assertion classifier. WIP-0416 retains the profile classifier after admitting Boolean source children. WIP-0420 retains the package-manifest token product, WIP-0421 retains the package-name validators, WIP-0422 retains the package-path validators, WIP-0424 retains semantic-version scalar and core validation, WIP-0425 retains prerelease validation with imported core calls, WIP-0426 retains semantic-version coordinates, WIP-0427 retains identifier precedence, WIP-0428 retains core precedence, WIP-0429 retains prerelease sequence order, WIP-0430 retains release precedence, WIP-0431 closes the semantic-version facade, WIP-0432 retains package-canonical coordinates, and WIP-0433 retains canonical line kinds. Each fresh test run links 397 functions and 14,272 instructions, retains 10,978 local types and 338,824 code bytes, and reproduces SHA-256 `f76cc6a95bb90a6a33096d6ad5eed26f0b4798becab890d5f27310509a917298`. Complete evidence remains bounded by the forty-five-minute method deadline.
