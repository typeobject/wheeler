...
`NativeCompilerPhysicalClosureExampleTest` now compares all 109 selected artifacts, retained prefixes, and relocations. WIP-0411 adds the direct assignment-syntax product and closes the wide-local dependency named by `CallForms.w`. WIP-0413 adds the guarded UTF-8 call owner without a broad token-module edge. WIP-0414 retains separate statement, decoder, signed, and nonsigned result owners. WIP-0415 retains the manifest assertion classifier. WIP-0416 retains the profile classifier after admitting Boolean source children. WIP-0420 retains the package-manifest token product. Each fresh test run links 289 functions and 11,210 instructions, retains 8,251 local types and 264,712 code bytes, and reproduces SHA-256 `b70bfeb03dcc9f6cb3822a3422d68a44047b4bd849350f5e5864c3b9a8df0965`. Complete evidence passes in about 19 minutes under the twenty-four-minute method deadline.
