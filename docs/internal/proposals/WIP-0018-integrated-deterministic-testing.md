...
- [x] Bounded scalar parameter products and digest-assigned deterministic shards execute for the accepted profile. WIP-0194 reproduces the complete case-identity shard assignment in a Wheeler conformance target. WIP-0195 derives that case identity from the canonical profile-2 transcript.
