...
- [x] The current semantic runtime matches generated circuit adjoints, coherently lifted finite XOR and width-modular constant add/subtract operations, exact symbolic parameter bindings, ordered batches and Pauli-Z observables, and canonical little-endian result integers. Wheeler library APIs remain.
