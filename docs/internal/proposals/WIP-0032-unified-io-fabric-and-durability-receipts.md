...
- [ ] Wheeler source owns the portable request, scope, operation, completion, queue, and effect-lowering API. The Java host scaffold then ceases to define semantic spelling.
