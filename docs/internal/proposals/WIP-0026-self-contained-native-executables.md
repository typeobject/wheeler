...
- [x] WIP-0373 adds physical ELF, Mach-O, and PE build and verify commands. They read exact bounded nonsymlink inputs once, strictly parse plan and ABI records, verify every WBC before build, self-verify output before atomic publication, and compose native-format and WBC verification without execution.
