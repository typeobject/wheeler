...
- [x] WIPs 0378 through 0380 lower one closed acyclic scalar WBC profile, including up to seven prior helpers and six exact scalar arguments per call, to x86-64 Linux AOT and observe its computed source-declared process status through a complete ELF launch. General AOT equivalence remains.
