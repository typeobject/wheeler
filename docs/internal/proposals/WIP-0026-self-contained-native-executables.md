...
- [x] WIPs 0378 and 0379 lower one closed acyclic scalar WBC profile, including up to seven prior zero-argument helper calls, to x86-64 Linux AOT and observe its computed source-declared process status through a complete ELF launch. General AOT equivalence remains.
