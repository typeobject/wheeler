...
The complete core suite covers committed updates, persistent snapshots, map updates, UTF-8 freeze, drop, exact rewind, malformed writes, allocation limits, observations, and task snapshots. The bounded bootstrap-manifest evidence accepted its 177,822-byte graph of 379 modules and 1,893 imports in exactly 74,201,056 committed transitions.
