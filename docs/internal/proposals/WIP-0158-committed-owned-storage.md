...
The complete core suite covers committed updates, persistent snapshots, map updates, UTF-8 freeze, drop, exact rewind, malformed writes, allocation limits, observations, and task snapshots. The bounded bootstrap-manifest test accepts the current 176,197-byte graph of 376 modules and 1,872 imports in exactly 73,615,774 committed transitions.
