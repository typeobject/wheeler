...
The complete core suite covers committed updates, persistent snapshots, map updates, UTF-8 freeze, drop, exact rewind, malformed writes, allocation limits, observations, and task snapshots. The bounded bootstrap-manifest test accepts the current 177,773-byte graph of 379 modules and 1,892 imports in exactly 74,172,747 committed transitions.
