...
- [x] `ArchiveModuleSources.w` joins all 339 physical compiler modules to exact digest-matching archive ranges. A mismatched source identity leaves publication untouched.
...
- The current 339-module compiler closure plans without truncation.
