...
The complete physical closure remains 379 modules, 1,892 imports, and 177,773 canonical manifest bytes. Native validation halts after 74,172,747 committed transitions. Wheeler SHA-256 consumes the same manifest in 34,021,744 transitions.
