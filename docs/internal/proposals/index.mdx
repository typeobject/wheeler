...
| [WIP-0080](WIP-0080-exact-root-boolean-declaration-products.md) | Implementing | Exact root Boolean declaration products | Self-hosting, Boolean values, declaration products |
