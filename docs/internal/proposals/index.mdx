...
| [WIP-0056](WIP-0056-measured-source-statement-local-products.md) | Implementing | Measured source statement local products | Self-hosting, source products, local types, structured control flow |
