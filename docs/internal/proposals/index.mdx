...
| [WIP-0079](WIP-0079-exact-signed-literal-return-products.md) | Implementing | Exact signed-literal return products | Self-hosting, scalar literals, return products |
