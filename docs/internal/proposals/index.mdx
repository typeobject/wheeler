...
| [WIP-0057](WIP-0057-source-call-relocation-and-ownership-coordinate-products.md) | Implementing | Source call, relocation, and ownership coordinate products | Self-hosting, calls, relocation, ownership, callable layout |
...
| [WIP-0060](WIP-0060-imported-call-stub-and-relocation-products.md) | Implementing | Imported call stub and relocation products | Self-hosting, imported calls, bytecode, relocation |
| [WIP-0061](WIP-0061-qualified-imported-source-calls.md) | Implementing | Qualified imported source calls | Self-hosting, imported calls, module names, resolution |
