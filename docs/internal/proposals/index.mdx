...
| [WIP-0064](WIP-0064-reversible-source-product-evidence.md) | Implementing | Reversible source-product evidence | Self-hosting, reversible source, ownership, proofs |
| [WIP-0065](WIP-0065-reversible-call-and-result-portfolio.md) | Draft | Reversible call and result portfolio | Self-hosting, reversible calls, result slots |
