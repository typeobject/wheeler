...
| [WIP-0052](WIP-0052-bounded-native-structured-loop-products.md) | Implementing | Bounded native structured-loop products | Self-hosting, structured control flow, callable products, bootstrap |
