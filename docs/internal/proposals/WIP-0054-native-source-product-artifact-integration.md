...
- [x] Outer and nested loop products call `LoopBodyInstructionEncoding.w`. The nested path consumes canonical resolved opcodes and no longer owns a private update encoding.
