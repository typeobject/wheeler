...
- [ ] Logical operation and magic-state planning.
  ...
  - [ ] Add code-distance and failure-budget planning, logical target capability admission, and rejection by physical targets lacking a verified logical lowering.
