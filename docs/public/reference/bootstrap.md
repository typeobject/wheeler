...
Its native identity run completes in 75,749,036 transitions. The native compiler
...
evidence compares 109 selected artifacts with stage 0 and closes every relocation.
Its executable subset contains 289 functions and 11,210 instructions. The complete
