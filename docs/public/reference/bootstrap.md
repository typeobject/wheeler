...
Its native identity run completes in 82,893,665 transitions. The native compiler
...
fields, and target-row prefix, name, root, and coordinate policy have retained
owners. The executable subset contains 438 functions and 15,909 instructions. The complete compiler has not reached a fixed
point.
