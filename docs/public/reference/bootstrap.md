...
398-module compiler closure with 1,944 imports and a 185,329-byte module manifest.
Its native identity run completes in 77,446,929 transitions. The native compiler
...
evidence compares 122 selected artifacts with stage 0 and closes every relocation.
Its executable subset contains 399 functions and 14,357 instructions. The complete
