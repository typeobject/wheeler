...
399-module compiler closure with 1,945 imports and a 185,621-byte module manifest.
Its native identity run completes in 77,705,584 transitions. The native compiler
...
evidence compares 123 selected artifacts with stage 0 and closes every relocation.
Its executable subset contains 402 functions and 14,425 instructions. The complete
