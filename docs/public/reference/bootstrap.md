...
404-module compiler closure with 1,951 imports and a 187,128-byte module manifest.
Its native identity run completes in 78,674,029 transitions. The native compiler
