...
zero-initialized `status` global and bounded straight-line constants, moves,
checked signed arithmetic, bitwise operations, one final store, and halt. Computed
