...
Its native identity run completes in 75,749,024 transitions. The native compiler
...
evidence compares 110 selected artifacts with stage 0 and closes every relocation.
Its executable subset contains 305 functions and 11,696 instructions. The complete
