...
417-module compiler closure with 1,978 imports and a 191,769-byte module manifest.
Its native identity run completes in 80,814,252 transitions. The native compiler
...
evidence compares 140 selected artifacts with stage 0 and closes every relocation.
...
validation have retained owners. The executable subset contains 429 functions
and 15,377 instructions. The complete compiler has not reached a fixed
point.
