...
For admitted successful classical executions, the test report's
`workflow_steps` field carries completed transitions of the tested artifact.
It includes calls, callee bodies, executed inverse bodies, and termination.
