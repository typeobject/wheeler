...
423-module compiler closure with 2,001 imports and a 194,504-byte module manifest.
Its native identity run completes in 82,685,935 transitions. The native compiler
...
evidence compares 146 selected artifacts with stage 0 and closes every relocation.
...
fields, and target-row prefix and name validation have retained owners. The
executable subset contains 435 functions and 15,827 instructions. The complete compiler has not reached a fixed
point.
