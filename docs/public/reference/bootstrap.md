...
Its native identity run completes in 75,749,054 transitions. The native compiler
...
evidence compares 111 selected artifacts with stage 0 and closes every relocation.
Its executable subset contains 317 functions and 12,120 instructions. The complete
