...
420-module compiler closure with 1,989 imports and a 193,132-byte module manifest.
Its native identity run completes in 81,581,849 transitions. The native compiler
...
evidence compares 143 selected artifacts with stage 0 and closes every relocation.
...
capability-row prefix validation have retained owners. The executable subset
contains 432 functions and 15,600 instructions. The complete compiler has not reached a fixed
point.
