...
424-module compiler closure with 2,005 imports and a 194,951-byte module manifest.
Its native identity run completes in 82,856,453 transitions. The native compiler
...
evidence compares 147 selected artifacts with stage 0 and closes every relocation.
...
fields, and target-row prefix, name, and root validation have retained owners. The
executable subset contains 436 functions and 15,901 instructions. The complete compiler has not reached a fixed
point.
