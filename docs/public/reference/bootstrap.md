...
385-module compiler closure with 1,921 imports and a 180,888-byte module manifest.
Its native identity run completes in 75,439,422 transitions. The native compiler
...
evidence compares 108 selected artifacts with stage 0 and closes every relocation.
Its executable subset contains 280 functions and 10,819 instructions. The complete
