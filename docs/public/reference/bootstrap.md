...
416-module compiler closure with 1,974 imports and a 191,291-byte module manifest.
Its native identity run completes in 80,624,517 transitions. The native compiler
...
evidence compares 139 selected artifacts with stage 0 and closes every relocation.
...
Quoted range coordinates, header scalar state, all four header fields, and their
composing facade have retained owners. The executable subset contains 428
functions and 15,298 instructions. The complete compiler has not reached a fixed
point.
