...
418-module compiler closure with 1,982 imports and a 192,232-byte module manifest.
Its native identity run completes in 81,074,974 transitions. The native compiler
...
evidence compares 141 selected artifacts with stage 0 and closes every relocation.
...
and name validation have retained owners. The executable subset contains 430
functions and 15,451 instructions. The complete compiler has not reached a fixed
point.
