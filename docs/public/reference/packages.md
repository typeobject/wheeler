...
The native conformance targets reproduce case identity, shard assignment, canonical outcome order, summaries, execution and coverage identities, failure diagnostics, and report identities for up to 128 cases.
