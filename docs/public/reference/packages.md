...
summary counts, complete execution identities, and semantic report identities for up to 64 cases without Java. Case identity, shard assignment, and summary reduction are canonical
