...
runtime. `image runtime-elf-x86-64-aot` verifies one closed straight-line scalar
WBC profile and publishes runtime text carrying its computed source-declared
process status.
