...
summary counts, complete execution and coverage identities, semantic report identities for up to 64 cases, and one passing or assertion-failing classical artifact-to-report run without Java. Case identity, shard assignment, and summary reduction are canonical
