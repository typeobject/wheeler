...
summary counts, complete execution and coverage identities, semantic report identities for up to 64 cases, and one- or two-case passing and assertion-failing classical artifact-to-report runs without Java. Case identity, shard assignment, and summary reduction are canonical
