 ...
 * - Opcode:    8 bits  (byte)
 * - Flags:     8 bits  (byte)
 * - Registers: 16 bits (short)
 * - Operand:   64 bits (long)
 * - History:   32 bits (int)
 */
public class Instruction {
    ...
    public short getRegisters() { return registers; }
    ...
    public String toString() {
        return String.format(
                ...
                InstructionSet.getInstructionName(opcode),
                flags,
                registers,
                operand,
                history
