...
public class InstructionSet {
    ...
    public static void verifyInstruction(byte opcode, byte flags, long operand) {
        ...
        if (requiresHistory(opcode) && !hasFlag(flags, Flags.HISTORY)) {
            throw new InvalidInstructionException(
                    "Instruction requires history tracking",
                    opcode,
                    0L
            );
        }
    ...
    private static boolean requiresHistory(byte opcode) {
        ...
        return opcode != SWAP && opcode != DUP &&
                opcode != FENCE && opcode != HQUERY;
    }
    ...
    public static String getInstructionName(byte opcode) {
        switch (opcode) {
            ...
            case THNEW: return "THNEW";
            case THJOIN: return "THJOIN";
            case THYIELD: return "THYIELD";
            case THEXIT: return "THEXIT";
            case LOCK: return "LOCK";
            case UNLOCK: return "UNLOCK";
            case BARRIER: return "BARRIER";
            case FENCE: return "FENCE";
            case CHCREATE: return "CHCREATE";
            case CHSEND: return "CHSEND";
            case CHRECV: return "CHRECV";
            case CHCLOSE: return "CHCLOSE";
            case TXBEGIN: return "TXBEGIN";
            case TXCOMMIT: return "TXCOMMIT";
            case TXABORT: return "TXABORT";
            case TXREAD: return "TXREAD";
            case TXWRITE: return "TXWRITE";
            case HSAVE: return "HSAVE";
            case HRESTORE: return "HRESTORE";
            case HGC: return "HGC";
            case HQUERY: return "HQUERY";
