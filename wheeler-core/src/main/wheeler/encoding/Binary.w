...
classical class Binary {
  ...
  public boolean validAsciiName(borrow byteview source, long start, long length) {
    if (length == 0) {
      return false;
    }
  ...
  public boolean validNumericRelease(borrow byteview source, long start, long length) {
    if (length < 5) {
      return false;
    }
  ...
  public boolean validAsciiPath(borrow byteview source, long start, long length) {
    if (length == 0) {
      return false;
    }
