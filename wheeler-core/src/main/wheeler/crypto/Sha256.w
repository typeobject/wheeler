...
classical class Sha256 {
  ...
  private void initializeConstants(borrow mut words constants) {
  ...
  public void hashSha256(borrow byteview input, borrow mut bytes digest, borrow mut region arena) {
