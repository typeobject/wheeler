...
/** Native evidence for direct literal-comparison classifier products. */
final class NativeCompilerLiteralComparisonOperationsPhysicalProductExampleTest {
  @Tag("closure-evidence")
  @Test
  void compilesLiteralComparisonOperationsByteForByte() throws Exception {
