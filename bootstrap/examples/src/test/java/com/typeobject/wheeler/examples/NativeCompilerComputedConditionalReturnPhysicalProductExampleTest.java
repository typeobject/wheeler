...
/** Native evidence for direct computed conditional-return products. */
final class NativeCompilerComputedConditionalReturnPhysicalProductExampleTest {
  @Tag("closure-evidence")
  @Test
  void compilesComputedConditionalReturnsByteForByte() throws Exception {
