...
/** Native evidence for focused forwarding-result products. */
final class NativeCompilerForwardedHelperResultKindsPhysicalProductExampleTest {
  @Tag("closure-evidence")
  @Test
  void compilesForwardedHelperResultKindsByteForByte() throws Exception {
    assertPhysicalProduct("wheeler.compiler.forwarded_helper_result_kinds");
  }

  @Tag("closure-evidence")
  @Test
  void compilesForwardedHelperResultStatementsByteForByte() throws Exception {
    assertPhysicalProduct("wheeler.compiler.forwarded_helper_result_statements");
  }
