...
/** Native evidence for direct helper-signature products. */
final class NativeCompilerHelperSignaturesPhysicalProductExampleTest {
  ...
  void compilesHelperSignaturesByteForByte() throws Exception {
    ...
    assertEquals(10, expectedProgram.functions().size());
    assertEquals(268, expectedProgram.functions().getFirst().forward().size());
