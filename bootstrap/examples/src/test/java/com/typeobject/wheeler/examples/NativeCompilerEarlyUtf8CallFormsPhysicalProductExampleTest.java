...
/** Native evidence for guarded UTF-8 owner-call syntax products. */
final class NativeCompilerEarlyUtf8CallFormsPhysicalProductExampleTest {
  @Tag("closure-evidence")
  @Test
  void compilesEveryGuardedUtf8CallHelperByteForByte() throws Exception {
    ...
    assertEquals(16, new BytecodeReader().read(expected).functions().size() - 1);
