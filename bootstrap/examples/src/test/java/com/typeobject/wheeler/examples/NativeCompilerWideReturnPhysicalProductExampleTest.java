...
/** Native evidence for direct scalar declaration products. */
final class NativeCompilerWideReturnPhysicalProductExampleTest {
  @Tag("closure-evidence")
  @Test
  void compilesBinaryDeclarationsByteForByte() throws Exception {
    var module = NativeCompilerArchiveClosureProgram.PHYSICAL_WIDE_RETURN_SOURCES_MODULE;
