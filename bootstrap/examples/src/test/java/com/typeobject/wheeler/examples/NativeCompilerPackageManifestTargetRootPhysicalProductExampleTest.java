...
/** Native physical evidence for package-manifest target roots. */
final class NativeCompilerPackageManifestTargetRootPhysicalProductExampleTest {
  private static final String MODULE = "wheeler.compiler.packages.manifest_target_root";

  @Tag("closure-evidence")
  @Test
  void retainsManifestTargetRootAndRelocatesPolicy() throws Exception {
