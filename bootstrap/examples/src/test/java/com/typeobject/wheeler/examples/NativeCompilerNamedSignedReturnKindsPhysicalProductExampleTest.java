...
/** Native evidence for direct signed return-classifier products. */
final class NativeCompilerNamedSignedReturnKindsPhysicalProductExampleTest {
  @Tag("closure-evidence")
  @Test
  void compilesNamedSignedReturnKindsByteForByte() throws Exception {
