...
/** Native evidence for direct resolved local-assignment range products. */
final class NativeCompilerResolvedLocalAssignmentsPhysicalProductExampleTest {
  @Tag("closure-evidence")
  @Test
  void compilesResolvedLocalAssignmentsByteForByte() throws Exception {
