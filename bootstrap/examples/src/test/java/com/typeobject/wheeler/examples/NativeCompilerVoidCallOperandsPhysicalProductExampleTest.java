...
/** Native evidence for direct imported void-call operand products. */
final class NativeCompilerVoidCallOperandsPhysicalProductExampleTest {
  @Tag("closure-evidence")
  @Test
  void retainsVoidCallOperandsAndRelocatesShapeQueries() throws Exception {
