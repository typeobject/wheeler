...
/** Native evidence for direct resolved local-loop classifier products. */
final class NativeCompilerResolvedLocalLoopKindsPhysicalProductExampleTest {
  @Tag("closure-evidence")
  @Test
  void compilesResolvedLocalLoopKindsByteForByte() throws Exception {
