...
/** Native physical evidence for the package-manifest header tail. */
final class NativeCompilerPackageManifestHeaderTailPhysicalProductExampleTest {
  private static final String MODULE = "wheeler.compiler.packages.manifest_header_tail";

  @Tag("closure-evidence")
  @Test
  void retainsManifestHeaderTailAndRelocatesPolicy() throws Exception {
