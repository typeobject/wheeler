...
/** Native evidence for direct scalar return-opcode selector products. */
final class NativeCompilerReturnOpcodeKindsPhysicalProductExampleTest {
  @Tag("closure-evidence")
  @Test
  void compilesReturnOpcodeKindsByteForByte() throws Exception {
