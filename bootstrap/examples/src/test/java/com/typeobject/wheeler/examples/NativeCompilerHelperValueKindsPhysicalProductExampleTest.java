...
/** Native evidence for the direct imported helper-value kind product. */
final class NativeCompilerHelperValueKindsPhysicalProductExampleTest {
  @Tag("closure-evidence")
  @Test
  void retainsHelperValueKindsAndRelocatesVoidClassification() throws Exception {
