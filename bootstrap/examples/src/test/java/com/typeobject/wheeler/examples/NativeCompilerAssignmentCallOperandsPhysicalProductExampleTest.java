...
/** Native evidence for direct imported assignment-call operand products. */
final class NativeCompilerAssignmentCallOperandsPhysicalProductExampleTest {
  @Tag("closure-evidence")
  @Test
  void retainsAssignmentCallOperandsAndRelocatesArity() throws Exception {
