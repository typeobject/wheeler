...
/** Native physical evidence for package-manifest dependency names. */
final class NativeCompilerPackageManifestDependencyNamePhysicalProductExampleTest {
  private static final String MODULE = "wheeler.compiler.packages.manifest_dependency_name";

  @Tag("closure-evidence")
  @Test
  void retainsManifestDependencyNameAndRelocatesPolicy() throws Exception {
