...
/** Native physical evidence for package-manifest target modules. */
final class NativeCompilerPackageManifestTargetModulePhysicalProductExampleTest {
  private static final String MODULE = "wheeler.compiler.packages.manifest_target_module";

  @Tag("closure-evidence")
  @Test
  void retainsManifestTargetModuleAndRelocatesPolicy() throws Exception {
