...
/** Native physical evidence for package-manifest dependency prefixes. */
final class NativeCompilerPackageManifestDependencyPrefixPhysicalProductExampleTest {
  private static final String MODULE =
      "wheeler.compiler.packages.manifest_dependency_prefix";

  @Tag("closure-evidence")
  @Test
  void retainsManifestDependencyPrefixAndRelocatesPolicy() throws Exception {
