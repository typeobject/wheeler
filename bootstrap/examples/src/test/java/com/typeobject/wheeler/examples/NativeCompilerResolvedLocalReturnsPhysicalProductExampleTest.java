...
/** Native evidence for direct resolved local-return products. */
final class NativeCompilerResolvedLocalReturnsPhysicalProductExampleTest {
  @Tag("closure-evidence")
  @Test
  void compilesResolvedLocalReturnsByteForByte() throws Exception {
