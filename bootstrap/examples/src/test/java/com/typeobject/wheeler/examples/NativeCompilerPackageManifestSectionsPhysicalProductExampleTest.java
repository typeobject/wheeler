...
/** Native physical evidence for package-manifest collection sections. */
final class NativeCompilerPackageManifestSectionsPhysicalProductExampleTest {
  private static final String MODULE = "wheeler.compiler.packages.manifest_sections";

  @Tag("closure-evidence")
  @Test
  void retainsManifestSectionsAndRelocatesKeys() throws Exception {
