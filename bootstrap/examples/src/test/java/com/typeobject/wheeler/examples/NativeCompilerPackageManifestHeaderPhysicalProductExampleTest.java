...
/** Native physical evidence for the complete package-manifest header. */
final class NativeCompilerPackageManifestHeaderPhysicalProductExampleTest {
  private static final String MODULE = "wheeler.compiler.packages.manifest_header";

  @Tag("closure-evidence")
  @Test
  void retainsManifestHeaderAndRelocatesFields() throws Exception {
