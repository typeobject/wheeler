...
/** Native evidence for direct scalar return products. */
final class NativeCompilerTypeKindsPhysicalProductExampleTest {
  @Tag("closure-evidence")
  @Test
  void compilesBitwiseReturnByteForByte() throws Exception {
    var module = NativeCompilerArchiveClosureProgram.PHYSICAL_TYPE_KINDS_MODULE;
