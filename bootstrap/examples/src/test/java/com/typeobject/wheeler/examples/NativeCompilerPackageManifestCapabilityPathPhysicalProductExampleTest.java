...
/** Native physical evidence for package-manifest capability paths. */
final class NativeCompilerPackageManifestCapabilityPathPhysicalProductExampleTest {
  private static final String MODULE = "wheeler.compiler.packages.manifest_capability_path";

  @Tag("closure-evidence")
  @Test
  void retainsManifestCapabilityPathAndRelocatesPolicy() throws Exception {
