...
/** Native physical evidence for package-manifest target source rows. */
final class NativeCompilerPackageManifestTargetSourceRowPhysicalProductExampleTest {
  private static final String MODULE = "wheeler.compiler.packages.manifest_target_source_row";

  @Tag("closure-evidence")
  @Test
  void retainsManifestTargetSourceRowAndRelocatesSelectorPolicy() throws Exception {
