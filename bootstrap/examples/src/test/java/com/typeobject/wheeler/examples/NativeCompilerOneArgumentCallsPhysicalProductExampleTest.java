...
/** Native evidence for direct one-argument call classifiers. */
final class NativeCompilerOneArgumentCallsPhysicalProductExampleTest {
  @Tag("closure-evidence")
  @Test
  void compilesOneArgumentCallsByteForByte() throws Exception {
