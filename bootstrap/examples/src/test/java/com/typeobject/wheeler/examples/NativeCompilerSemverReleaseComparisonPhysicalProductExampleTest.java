...
/** Native evidence for complete semantic-version release precedence. */
final class NativeCompilerSemverReleaseComparisonPhysicalProductExampleTest {
  private static final String MODULE = "wheeler.compiler.packages.semver_release_comparison";

  @Tag("closure-evidence")
  @Test
  void retainsReleaseComparisonAndRelocatesBothOrders() throws Exception {
