...
/** Native evidence for direct resolved void-call classifiers. */
final class NativeCompilerVoidCallKindsPhysicalProductExampleTest {
  @Tag("closure-evidence")
  @Test
  void compilesVoidCallKindsByteForByte() throws Exception {
