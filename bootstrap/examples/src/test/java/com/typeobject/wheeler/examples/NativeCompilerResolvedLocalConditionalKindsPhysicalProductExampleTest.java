...
/** Native evidence for direct resolved local-conditional classifiers. */
final class NativeCompilerResolvedLocalConditionalKindsPhysicalProductExampleTest {
  @Tag("closure-evidence")
  @Test
  void compilesResolvedLocalConditionalKindsByteForByte() throws Exception {
