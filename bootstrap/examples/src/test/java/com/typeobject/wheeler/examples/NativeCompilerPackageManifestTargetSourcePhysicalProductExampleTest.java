...
/** Native physical evidence for package-manifest target sources. */
final class NativeCompilerPackageManifestTargetSourcePhysicalProductExampleTest {
  private static final String MODULE = "wheeler.compiler.packages.manifest_target_source";

  @Tag("closure-evidence")
  @Test
  void retainsManifestTargetSourceAndRelocatesPolicy() throws Exception {
