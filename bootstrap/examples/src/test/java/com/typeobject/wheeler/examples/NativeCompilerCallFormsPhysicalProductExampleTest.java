...
/** Native evidence for direct imported call-form products. */
final class NativeCompilerCallFormsPhysicalProductExampleTest {
  @Tag("closure-evidence")
  @Test
  void compilesCallFormsByteForByte() throws Exception {
    var module = NativeCompilerPhysicalSelection.callable("wheeler.compiler.call_forms");
