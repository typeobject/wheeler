...
/** Native evidence for direct Boolean declaration-classifier products. */
final class NativeCompilerBooleanDeclarationKindsPhysicalProductExampleTest {
  @Tag("closure-evidence")
  @Test
  void compilesBooleanDeclarationKindsByteForByte() throws Exception {
