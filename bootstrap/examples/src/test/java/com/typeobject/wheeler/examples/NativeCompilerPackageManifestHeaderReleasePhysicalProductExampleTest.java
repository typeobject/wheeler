...
/** Native physical evidence for the package-manifest header release. */
final class NativeCompilerPackageManifestHeaderReleasePhysicalProductExampleTest {
  private static final String MODULE = "wheeler.compiler.packages.manifest_header_release";

  @Tag("closure-evidence")
  @Test
  void retainsManifestHeaderReleaseAndRelocatesPolicy() throws Exception {
