...
/** Native physical evidence for the optional package-manifest target module head. */
final class NativeCompilerPackageManifestTargetModuleHeadPhysicalProductExampleTest {
  private static final String MODULE = "wheeler.compiler.packages.manifest_target_module_head";

  @Tag("closure-evidence")
  @Test
  void retainsManifestTargetModuleHeadAndRelocatesFieldPolicy() throws Exception {
