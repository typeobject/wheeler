...
/** Native evidence for direct early-return result classifiers. */
final class NativeCompilerEarlyReturnResultKindsPhysicalProductExampleTest {
  @Tag("closure-evidence")
  @Test
  void compilesEarlyReturnResultKindsByteForByte() throws Exception {
