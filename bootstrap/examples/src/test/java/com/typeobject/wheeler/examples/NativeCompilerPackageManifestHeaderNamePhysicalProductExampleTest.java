...
/** Native physical evidence for the package-manifest header name. */
final class NativeCompilerPackageManifestHeaderNamePhysicalProductExampleTest {
  private static final String MODULE = "wheeler.compiler.packages.manifest_header_name";

  @Tag("closure-evidence")
  @Test
  void retainsManifestHeaderNameAndRelocatesPolicy() throws Exception {
