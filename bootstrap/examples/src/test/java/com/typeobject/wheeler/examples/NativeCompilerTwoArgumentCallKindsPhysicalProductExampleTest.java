...
/** Native evidence for direct two-argument call classifiers. */
final class NativeCompilerTwoArgumentCallKindsPhysicalProductExampleTest {
  @Tag("closure-evidence")
  @Test
  void compilesTwoArgumentCallKindsByteForByte() throws Exception {
