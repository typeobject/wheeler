...
final class NativeCompilerPhysicalModules {
  ...
  static List<NativeCompilerArchiveClosureProgram.PhysicalModule> all() {
    return List.of(
        ...
        physical(
            "compiler/packages/canonical/PackageCanonicalTokenState.w",
            "packages.canonical_token_state"),
        ...
        physical(
            "compiler/packages/manifest/PackageManifestRanges.w",
  ...
  static List<NativeCompilerArchiveClosureProgram.PhysicalModule> importedCallableProducts() {
    return List.of(
        ...
        physical(
            "compiler/packages/manifest/PackageManifestKeys.w",
        ...
        physical(
            "compiler/packages/manifest/header/PackageManifestHeaderTail.w",
        ...
        physical(
            "compiler/packages/manifest/target/PackageManifestTargetName.w",
            "packages.manifest_target_name"),
        physical(
            "compiler/packages/manifest/target/PackageManifestTargetRoot.w",
        ...
        physical(
            "compiler/packages/manifest/target/source/PackageManifestTargetSourceCollection.w",
            "packages.manifest_target_source_collection"),
        physical(
