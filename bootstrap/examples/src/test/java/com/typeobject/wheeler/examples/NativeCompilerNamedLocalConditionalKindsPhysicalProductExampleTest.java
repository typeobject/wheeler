...
/** Native evidence for direct named local-conditional classifiers. */
final class NativeCompilerNamedLocalConditionalKindsPhysicalProductExampleTest {
  @Tag("closure-evidence")
  @Test
  void compilesNamedLocalConditionalKindsByteForByte() throws Exception {
