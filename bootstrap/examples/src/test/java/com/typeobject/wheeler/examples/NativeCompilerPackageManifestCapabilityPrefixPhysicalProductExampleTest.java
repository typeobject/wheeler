...
/** Native physical evidence for package-manifest capability prefixes. */
final class NativeCompilerPackageManifestCapabilityPrefixPhysicalProductExampleTest {
  private static final String MODULE =
      "wheeler.compiler.packages.manifest_capability_prefix";

  @Tag("closure-evidence")
  @Test
  void retainsManifestCapabilityPrefixAndRelocatesPolicy() throws Exception {
