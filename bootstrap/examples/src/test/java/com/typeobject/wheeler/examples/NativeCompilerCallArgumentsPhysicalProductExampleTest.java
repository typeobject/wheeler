...
/** Native evidence for direct typed call-argument products. */
final class NativeCompilerCallArgumentsPhysicalProductExampleTest {
  @Tag("closure-evidence")
  @Test
  void compilesCallArgumentsByteForByte() throws Exception {
