...
/** Native evidence for the complete semantic-version facade. */
final class NativeCompilerSemverFacadePhysicalProductExampleTest {
  private static final String MODULE = "wheeler.compiler.packages.semver";

  @Tag("closure-evidence")
  @Test
  void retainsTheFacadeAndRelocatesValidationAndPrecedence() throws Exception {
