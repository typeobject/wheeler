...
/** Native evidence for direct call-assignment arity products. */
final class NativeCompilerAssignmentCallAritiesPhysicalProductExampleTest {
  @Tag("closure-evidence")
  @Test
  void compilesAssignmentCallAritiesByteForByte() throws Exception {
