...
/** Native evidence for direct comparison-classifier products. */
final class NativeCompilerNamedComparisonKindsPhysicalProductExampleTest {
  @Tag("closure-evidence")
  @Test
  void compilesNamedComparisonKindsByteForByte() throws Exception {
