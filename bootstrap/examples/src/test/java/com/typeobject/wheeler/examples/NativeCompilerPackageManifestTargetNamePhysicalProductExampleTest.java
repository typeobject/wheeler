...
/** Native physical evidence for package-manifest target names. */
final class NativeCompilerPackageManifestTargetNamePhysicalProductExampleTest {
  private static final String MODULE = "wheeler.compiler.packages.manifest_target_name";

  @Tag("closure-evidence")
  @Test
  void retainsManifestTargetNameAndRelocatesPolicy() throws Exception {
