...
/** Native physical evidence for package-manifest target prefixes. */
final class NativeCompilerPackageManifestTargetPrefixPhysicalProductExampleTest {
  private static final String MODULE =
      "wheeler.compiler.packages.manifest_target_prefix";

  @Tag("closure-evidence")
  @Test
  void retainsManifestTargetPrefixAndRelocatesPolicy() throws Exception {
