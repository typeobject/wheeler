...
/** Native evidence for direct resolved local-conditional source decoders. */
final class NativeCompilerResolvedLocalConditionalSourcesPhysicalProductExampleTest {
  @Tag("closure-evidence")
  @Test
  void compilesResolvedLocalConditionalSourcesByteForByte() throws Exception {
