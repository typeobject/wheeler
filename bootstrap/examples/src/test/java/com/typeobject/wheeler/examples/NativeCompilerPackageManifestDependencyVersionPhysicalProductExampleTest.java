...
/** Native physical evidence for package-manifest dependency versions. */
final class NativeCompilerPackageManifestDependencyVersionPhysicalProductExampleTest {
  private static final String MODULE = "wheeler.compiler.packages.manifest_dependency_version";

  @Tag("closure-evidence")
  @Test
  void retainsManifestDependencyVersionAndRelocatesPolicy() throws Exception {
