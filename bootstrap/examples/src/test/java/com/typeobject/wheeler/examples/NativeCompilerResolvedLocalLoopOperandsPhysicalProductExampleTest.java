...
/** Native evidence for direct resolved loop-operand products. */
final class NativeCompilerResolvedLocalLoopOperandsPhysicalProductExampleTest {
  @Tag("closure-evidence")
  @Test
  void compilesResolvedLoopOperandsByteForByte() throws Exception {
