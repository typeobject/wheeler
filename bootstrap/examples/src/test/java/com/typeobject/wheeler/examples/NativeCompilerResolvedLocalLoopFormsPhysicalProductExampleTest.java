...
/** Native evidence for direct resolved local-loop form products. */
final class NativeCompilerResolvedLocalLoopFormsPhysicalProductExampleTest {
  @Tag("closure-evidence")
  @Test
  void compilesResolvedLocalLoopFormsByteForByte() throws Exception {
