...
/** Native evidence for the direct package-name validation product. */
final class NativeCompilerPackageNamesPhysicalProductExampleTest {
  @Tag("closure-evidence")
  @Test
  void compilesPackageNamesByteForByte() throws Exception {
