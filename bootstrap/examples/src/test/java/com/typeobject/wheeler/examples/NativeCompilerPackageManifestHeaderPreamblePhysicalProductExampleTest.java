...
/** Native physical evidence for the package-manifest header preamble. */
final class NativeCompilerPackageManifestHeaderPreamblePhysicalProductExampleTest {
  private static final String MODULE =
      "wheeler.compiler.packages.manifest_header_preamble";

  @Tag("closure-evidence")
  @Test
  void retainsManifestHeaderPreambleAndRelocatesPolicy() throws Exception {
