...
/** Native evidence for the direct package-path validation product. */
final class NativeCompilerPackagePathsPhysicalProductExampleTest {
  @Tag("closure-evidence")
  @Test
  void compilesPackagePathsByteForByte() throws Exception {
