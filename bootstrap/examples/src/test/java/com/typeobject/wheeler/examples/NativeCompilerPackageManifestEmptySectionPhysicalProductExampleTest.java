...
/** Native physical evidence for empty package-manifest sections. */
final class NativeCompilerPackageManifestEmptySectionPhysicalProductExampleTest {
  private static final String MODULE = "wheeler.compiler.packages.manifest_empty_section";

  @Tag("closure-evidence")
  @Test
  void retainsManifestEmptySectionAndRelocatesBrackets() throws Exception {
