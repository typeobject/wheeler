...
- `testing/` publishes runtime-owned case and execution identities, shard assignments, canonical summaries, report identities for up to 64 cases, and bounded artifact outcomes.
