...
- `testing/` publishes runtime-owned identities, summaries, reports, outcomes, and metadata.
  `testing/runners/NativeTestRunner.w` accepts up to 64 ordered artifact cases. It checks the package, runnable target, root module, schema-3 lock structure, source plan, strict UTF-8 modules, acyclic ordered local imports, descriptors, and shard selection before execution.
