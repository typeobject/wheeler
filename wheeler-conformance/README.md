...
- `testing/` publishes runtime-owned case, execution, and coverage identities, shard assignments, canonical summaries, report identities for up to 64 cases, bounded artifact outcomes, verified artifact metadata, composed artifact execution identities, and one-case or two-case passing and assertion-failing thin test publishers over runtime-owned descriptor validation, source and case identities, shard selection, execution, diagnostics, and reduction.
