...
classical class TestLimits {
  ...
  public const long MAX_TEST_CASES = 128;
  ...
  public const long MAX_TEST_REPORT_ROWS_BYTES = 684160;
  /// Caps a published identity, summary, row length, and complete rows.
  public const long MAX_TEST_REPORT_PUBLICATION_BYTES = 684203;
  /// Caps raw case identities before summary reduction.
  public const long MAX_TEST_SUMMARY_ROWS_BYTES = 4096;
}
