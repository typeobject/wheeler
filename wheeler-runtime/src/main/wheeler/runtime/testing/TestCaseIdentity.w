//! Derives canonical profile-2 test-case identities.

module wheeler.runtime.testing.test_case_identity;

import wheeler.core.encoding.binary;
import wheeler.crypto.sha256;

classical class TestCaseIdentity {
  ...
  /// Writes one raw SHA-256 case identity after complete frame validation.
  public long deriveTestCaseIdentity(borrow byteview input, borrow mut bytes output) {
