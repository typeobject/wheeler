...
the five-module direct star, chain, four-leaf fork, three-leaf fork beside a direct import, or one chain edge beside three direct imports. Differential fixtures exhaust all 120 input orders for each graph. A leaf
...
shared-dependency diamond, and the five-module direct star, chain, four-leaf fork, three-leaf fork beside a direct import, and one chain edge beside three direct imports while preventing intermediate
