...
Loop instruction staging follows active body, loop, and call counts. `StatementKinds.w` owns 139 unresolved statement identities. `LoopKinds.w` owns six loop-form
