...
return its parameter minus or modulo one scalar. A seventeenth helper fails
...
spelling the leaf name loudly. One bounded direct edge may give a dependency one through fifteen helpers while the root owns the remainder of the sixteen-helper table.
