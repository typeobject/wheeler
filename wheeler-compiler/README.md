...
full instruction-target table private instead of copying one MiB to the caller. `StatementKinds.w` owns 139 unresolved statement identities. `LoopKinds.w` owns six loop-form
