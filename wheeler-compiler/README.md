...
collector to helper and entry bodies. A table of two through twenty-three helpers may
precede an entry. Every entry call resolves to an exact table row, code generation emits
