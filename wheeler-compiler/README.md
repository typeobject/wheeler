...
spelling the leaf name loudly. One bounded direct edge may give a dependency one through fifteen helpers while the root owns the remainder of the twenty-two-helper table.
A sixteenth dependency helper fails before publication. One three-module chain may first resolve a constant owner into that dependency. Both paths preserve
