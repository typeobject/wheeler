...
constant. Its entry starts with one or more result calls and may then assert those results
against signed literals or constants. The emitted function flags, adjacent slot locals, forward
