...
- `compiler/graphs/five/FiveMixed.w` owns one chain edge beside three direct imports, including a constant-fed helper beside three direct constant owners.
...
`compiler/syntax/returns/EarlyComparisonForms.w` and `compiler/syntax/returns/ResolvedLocalReturns.w`
