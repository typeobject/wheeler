...
Separate closure evidence retains 107 physical source products. Direct `AssignmentCallSyntax.w`, `WideLocalCalls.w`, `EarlyUtf8CallForms.w`, and the focused result owners require no dependency-source projection. The resulting executable subset contains 279 functions and 10,754 instructions.
