...
- `compiler/closure/symbols` owns exact direct-import forwarding and package-bound symbol identities without enlarging the source indexer past its native token window.
