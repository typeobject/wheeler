...
- `compiler/closure/ModuleSymbols.w` destroys each staged source after publishing counted scalar declaration products and direct-edge public-symbol counts.
