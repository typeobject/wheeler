...
`compiler/resolution/returns/FiveArgumentReturns.w`, imported-constant
...
identities. `ResolvedStatements.w` owns eighty-six resolved columns. `BorrowedIntrinsicKinds.w`
