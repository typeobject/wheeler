...
Separate closure evidence retains 106 physical source products. Direct `AssignmentCallSyntax.w`, `WideLocalCalls.w`, `EarlyUtf8CallForms.w`, and the focused result owners require no dependency-source projection. The resulting executable subset contains 278 functions and 10,751 instructions.
