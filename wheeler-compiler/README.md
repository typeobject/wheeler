...
Separate closure evidence retains 100 physical source products. Direct `AssignmentCallSyntax.w`, `WideLocalCalls.w`, and `EarlyUtf8CallForms.w` products require no dependency-source projection. The resulting executable subset contains 278 functions and 10,611 instructions.
