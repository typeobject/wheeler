...
owns separate source and resolved `bufferLength`, `utf8Scalar`, `utf8Width`, indexed-buffer, and mutable-buffer statement identities. The focused
frontend syntax, typed resolution, and backend codegen owners validate, resolve, and emit their canonical forms. `Tokens.w` now sticks to
