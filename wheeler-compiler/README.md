...
the five-module direct star, chain, four-leaf fork, three-leaf fork beside a direct import, one chain edge beside three direct imports, a two-leaf fork beside two direct imports, or two independent chains beside a direct import. Differential fixtures exhaust all 120 input orders for each graph. A leaf
...
shared-dependency diamond, and the five-module direct star, chain, four-leaf fork, three-leaf fork beside a direct import, one chain edge beside three direct imports, a two-leaf fork beside two direct imports, and two independent chains beside a direct import while preventing intermediate
