...
constant. Its entry interleaves one or more result calls with signed-literal or constant
checks of results already produced. The emitted function flags, adjacent slot locals, forward
