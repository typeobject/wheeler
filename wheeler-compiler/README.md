...
and one- or two-argument scalar helper calls. Calls may mix constants with prior locals.
The resolver rejects helper parameters or locals that reuse constant names. Constants create no global,
