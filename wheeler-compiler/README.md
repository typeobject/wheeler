...
- `compiler/closure/ModuleSymbols.w` destroys each staged source after publishing counted scalar declaration products, direct-edge public-symbol counts, and package-bound symbol identities.
