...
owns separate source and resolved `bufferLength` and `utf8Scalar` statement identities. The focused
frontend syntax and backend codegen owners validate and emit their canonical forms. `Tokens.w` now sticks to
