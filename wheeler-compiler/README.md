...
and source-product coordinates likewise publish only planned rows. `StatementKinds.w` owns 139 unresolved statement identities. `LoopKinds.w` owns six loop-form
