...
classical class SevenDagGraphs {
  ...
  private SevenDagCompilation compileOrderedSharedDiamondSide(
    borrow utf8 sharedSource,
    borrow utf8 firstMiddleSource,
    borrow utf8 secondMiddleSource,
    ...
    utf8 secondLinkedDependentSource = linkSevenSharedResolvedConstant(
      linkedSecondMiddleSource,
      firstLinkedDependentSource,
      THREE_IMPORTS,
      secondDependentArena
  ...
  /// Compiles one shared diamond with a side leaf beside two direct imports.
  public SevenDagCompilation compileSevenSharedDiamondSideAndDirects(
    SevenGraphPlan plan,
    borrow utf8 firstSource,
    borrow utf8 secondSource,
    borrow utf8 thirdSource,
    ...
    SevenDagCompilation compiled = compileOrderedSharedDiamondSide(
      sharedSource,
      firstMiddleSource,
      secondMiddleSource,
      sideLeafSource,
  ...
  private SevenDagCompilation compileOrderedSerialDiamonds(
  ...
  public SevenDagCompilation compileSevenSerialDiamonds(
    SevenGraphPlan plan,
    borrow utf8 firstSource,
    borrow utf8 secondSource,
    borrow utf8 thirdSource,
    ...
    region firstArena = new region(/* bytes= */ MAX_LINKED_SOURCE_BYTES, /* allocations= */ 1);
    utf8 firstSharedSource = copySelectedSevenSource(
      plan.first,
      firstSource,
      secondSource,
      thirdSource,
    ...
    region fourthArena = new region(/* bytes= */ MAX_LINKED_SOURCE_BYTES, /* allocations= */ 1);
    utf8 secondSharedSource = copySelectedSevenSource(
      plan.fourth,
      firstSource,
      secondSource,
      thirdSource,
    ...
    region sixthArena = new region(/* bytes= */ MAX_LINKED_SOURCE_BYTES, /* allocations= */ 1);
    utf8 fourthMiddleSource = copySelectedSevenSource(
      plan.sixth,
      firstSource,
      secondSource,
      thirdSource,
    ...
    SevenDagCompilation compiled = compileOrderedSerialDiamonds(
      firstSharedSource,
      firstMiddleSource,
      secondMiddleSource,
      secondSharedSource,
