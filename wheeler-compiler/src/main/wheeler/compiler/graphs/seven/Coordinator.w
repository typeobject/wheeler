...
classical class CompilerGraphSeven {
  ...
  public SevenGraphCompilation compileSevenConstantGraph(
    ...
    if (plan.topology == SEVEN_PLAN_UNEVEN_NESTED_FORK_AND_DIRECTS) {
      SevenNestedCompilation unevenNested = compileSevenUnevenNestedForkAndDirects(
        plan,
        firstImportedSource,
        secondImportedSource,
        thirdImportedSource,
    ...
    if (plan.topology == SEVEN_PLAN_EXTENDED_FORK_AND_DIRECTS) {
      SevenNestedCompilation extendedFork = compileSevenExtendedForkAndDirects(
        plan,
        firstImportedSource,
        secondImportedSource,
        thirdImportedSource,
      ...
      return new SevenGraphCompilation(extendedFork.length, extendedFork.codeStart);
    }

    if (plan.topology == SEVEN_PLAN_LONG_BRANCH_FORK_AND_DIRECTS) {
      SevenNestedCompilation longBranch = compileSevenLongBranchForkAndDirects(
        plan,
        firstImportedSource,
        secondImportedSource,
        thirdImportedSource,
    ...
    if (plan.topology == SEVEN_PLAN_SHARED_DIAMOND_SIDE_AND_DIRECTS) {
      SevenDagCompilation diamondSide = compileSevenSharedDiamondSideAndDirects(
        plan,
        firstImportedSource,
        secondImportedSource,
        thirdImportedSource,
