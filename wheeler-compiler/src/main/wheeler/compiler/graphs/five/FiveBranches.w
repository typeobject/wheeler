...
classical class CompilerFiveBranches {
  ...
  private FiveBranchCompilation compileForkAndDirectIfOrdered(
  ...
  private FiveBranchCompilation compileWithDependent(
    borrow utf8 dependentSource,
    ...
    FiveBranchCompilation compiled = compileForkAndDirectIfOrdered(
  ...
  /// Compiles a three-leaf fork beside one direct root module.
  public FiveBranchCompilation compileFiveForkAndDirect(
    ...
    FiveBranchCompilation compiled = compileWithDependent(
      firstSource,
      secondSource,
      thirdSource,
      fourthSource,
