...
classical class CompilerFiveNestedFork {
  ...
  private FiveNestedForkCompilation compileIfOrdered(
  ...
  private FiveNestedForkCompilation compileRemainder(
    borrow utf8 firstLeafSource,
    borrow utf8 secondLeafSource,
    borrow utf8 middleSource,
    ...
    FiveNestedForkCompilation compiled = compileIfOrdered(
      firstLeafSource,
      secondLeafSource,
      middleSource,
  ...
  private FiveNestedForkCompilation compileWithMiddle(
    borrow utf8 middleSource,
    borrow utf8 firstRemainingSource,
    borrow utf8 secondRemainingSource,
    ...
    FiveNestedForkCompilation compiled = compileRemainder(
      firstRemainingSource,
      secondRemainingSource,
      middleSource,
  ...
  /// Compiles one two-leaf fork through a second two-input dependent.
  public FiveNestedForkCompilation compileFiveNestedFork(
    ...
    FiveNestedForkCompilation compiled = compileWithMiddle(
      firstSource,
      secondSource,
      thirdSource,
      fourthSource,
