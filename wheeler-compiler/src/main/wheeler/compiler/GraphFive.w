...
classical class CompilerGraphFive {
  ...
  private FiveGraphCompilation compileFourLeafForkIfOrdered(
  ...
  private FiveGraphCompilation compileFourLeafFork(
    ...
    FiveGraphCompilation compiled = compileFourLeafForkIfOrdered(
      secondSource,
      thirdSource,
      fourthSource,
      fifthSource,
  ...
  public FiveGraphCompilation compileFiveConstantGraph(
    ...
    FiveGraphCompilation compiled = compileFourLeafFork(
      firstSource,
      secondSource,
      thirdSource,
      fourthSource,
