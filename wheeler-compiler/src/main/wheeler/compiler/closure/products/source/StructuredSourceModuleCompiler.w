...
classical class StructuredSourceModuleCompiler {
  ...
  public SourceProductArtifactPlan compileStructuredSourceModuleWithTargets(
    ...
    words localTargetResultTypes = allocate(products, 4096);
    words returnRows = allocate(products, 192);
    words directTypes = allocate(products, 12288);
    bytes directCode = allocateBytes(products, 262144);
    words composedCallables = allocate(products, 320);
    words composedTypes = allocate(products, 12288);
    bytes composedCode = allocateBytes(products, 262144);
    words callableNameStarts = allocate(products, 4096);
