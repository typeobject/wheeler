...
classical class SourceGlobalSchema {
  ...
  /// Counts copied name start, name length, signed value, and source declaration start.
  public const long SOURCE_GLOBAL_COLUMNS = 4;
  ...
  /// Retains the declaration name's byte start in the immutable module source.
  public const long SOURCE_GLOBAL_DECLARATION_ROW = SOURCE_GLOBAL_VALUE_ROW + MAX_SOURCE_GLOBALS;
  ...
  /// Starts canonical name IDs after the complete declaration-product columns.
